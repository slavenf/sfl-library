...
int main()
{
    ...
    {
        sfl::small_unordered_flat_map<xint, xstr, 0, std::equal_to<xint>,
            TPARAM_ALLOCATOR<std::pair<xint, xstr>>
        > m1;

        const sfl::small_unordered_flat_map<xint, xstr, 0, std::equal_to<xint>,
            TPARAM_ALLOCATOR<std::pair<xint, xstr>>
        > m2;

        sfl::small_unordered_flat_map<xint, xstr, 5, std::equal_to<xint>,
            TPARAM_ALLOCATOR<std::pair<xint, xstr>>
        > m3;

        const sfl::small_unordered_flat_map<xint, xstr, 5, std::equal_to<xint>,
            TPARAM_ALLOCATOR<std::pair<xint, xstr>>
        > m4;
    ...
    {
        sfl::small_unordered_flat_map<Person, xstr, 0, PersonEqual,
            TPARAM_ALLOCATOR<std::pair<Person, xstr>>
        > m1;

        const sfl::small_unordered_flat_map<Person, xstr, 0, PersonEqual,
            TPARAM_ALLOCATOR<std::pair<Person, xstr>>
        > m2;
    ...
    {
        sfl::small_unordered_flat_map<xint, xstr, 3, std::equal_to<xint>,
            TPARAM_ALLOCATOR<std::pair<xint, xstr>>
        > m;
...

        {
            ...
            CHECK(res == std::make_pair(m.nth(4), true));
            CHECK(m.size() == 5);
            CHECK(m.capacity() == 6);
            CHECK(m.nth(0)->first == 30 && m.nth(0)->second == "/30/");
            CHECK(m.nth(1)->first == 10 && m.nth(1)->second == "/10/");
...

        {
            ...
            CHECK(res == std::make_pair(m.nth(4), false));
        }
    }
    ...
    cout << "Test emplace(Args&&...) (N == 0, with reallocation)." << endl;
    {
...

        {
            ...
            CHECK(m.size() == 3);
            CHECK(m.capacity() == 4);
            CHECK(m.nth(0)->first == 15 && m.nth(0)->second == "/15/");
            CHECK(m.nth(1)->first == 20 && m.nth(1)->second == "/20/");
...

        {
            ...
            CHECK(m.size() == 5);
            CHECK(m.capacity() == 8);
            CHECK(m.nth(0)->first == 16 && m.nth(0)->second == "/16/");
            CHECK(m.nth(1)->first == 15 && m.nth(1)->second == "/15/");
            CHECK(m.nth(2)->first == 20 && m.nth(2)->second == "/20/");
            CHECK(m.nth(3)->first == 10 && m.nth(3)->second == "/10/");
    ...
    {
        sfl::small_unordered_flat_map<xint, xstr, 10, std::equal_to<xint>,
            TPARAM_ALLOCATOR<std::pair<xint, xstr>>
        > m;
    ...
    {
        sfl::small_unordered_flat_map<Person, xstr, 10, PersonEqual,
            TPARAM_ALLOCATOR<std::pair<Person, xstr>>
        > m;
    ...
    cout << "Test insert(value_type&&)." << endl;
    {
...

        {
            ...
            CHECK(res == std::make_pair(m.nth(0), false));
            CHECK(v.first == 10 && v.second == "/10.1/");
        }
    ...
    cout << "Test insert_or_assign(const Key&, M&&)." << endl;
    {
...

        {
            ...
            CHECK(m.nth(0)->first == 10 && m.nth(0)->second == "/10.1/");
            CHECK(m.nth(1)->first == 20 && m.nth(1)->second == "/20.1/");
            CHECK(m.nth(2)->first == 15 && m.nth(2)->second == "/15.1/");
        }
    }
    ...
    cout << "Test initializer_list assignment operator." << endl;
    {
        ...
        CHECK(m1.capacity() == 5);
        CHECK(m1.nth(0)->first == 20 && m1.nth(0)->second == "/20/");
        CHECK(m1.nth(1)->first == 22 && m1.nth(1)->second == "/22/");
        CHECK(m1.nth(2)->first == 21 && m1.nth(2)->second == "/21/");
    }
    ...
    cout << "Test non-member erase_if(small_unordered_flat_map&, Predicate)." << endl;
    {
        ...
        using const_reference =
            typename sfl::small_unordered_flat_map<xint, xstr, 10, std::equal_to<xint>,
                TPARAM_ALLOCATOR<std::pair<xint, xstr>>
            >::const_reference;
