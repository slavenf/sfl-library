...
template <>
void test_small_unordered_flat_map<1>()
{
...
template <>
void test_small_unordered_flat_map<2>()
{
    #undef   TPARAM_ALLOCATOR
...
template <>
void test_small_unordered_flat_map<3>()
{
    #undef   TPARAM_ALLOCATOR
...
template <>
void test_small_unordered_flat_map<4>()
{
    #undef   TPARAM_ALLOCATOR
...
template <>
void test_small_unordered_flat_map<5>()
{
    #undef   TPARAM_ALLOCATOR
...
int main()
{
    ...
    test_small_unordered_flat_map<2>();
    test_small_unordered_flat_map<3>();
    test_small_unordered_flat_map<4>();
    test_small_unordered_flat_map<5>();
}
