...
void test_static_unordered_linear_multiset()
{
    using sfl::test::xint;
    ...
    {
        sfl::static_unordered_linear_multiset<xint_xint, 100, std::equal_to<xint_xint>> set;
    ...
    {
        CHECK((sfl::static_unordered_linear_multiset<xint_xint, 100, std::equal_to<xint_xint>>::static_capacity == 100));
    }
    ...
    {
        {
            sfl::static_unordered_linear_multiset<xint, 100, std::equal_to<xint>> set;
        ...
        {
            sfl::static_unordered_linear_multiset<xobj, 100, xobj::equal> set;
    ...
    PRINT("Test insert_range(Range&&");
    {
        // Input iterator (exactly)
        {
            ...
            sfl::static_unordered_linear_multiset<xint, 32, std::equal_to<xint>> set;
    ...
    PRINT("Test swap(container&)");
    {
        ...
        // set1.size() == set2.size()
        {
            sfl::static_unordered_linear_multiset<xint_xint, 100, std::equal_to<xint_xint>> set1, set2;
    ...
    PRINT("Test container(const KeyEqual&)");
    {
        ...
        sfl::static_unordered_linear_multiset<xint_xint, 100, std::equal_to<xint_xint>> set(equal);
    ...
    PRINT("Test container(InputIt, InputIt)");
    {
        ...
        sfl::static_unordered_linear_multiset<xint_xint, 100, std::equal_to<xint_xint>> set(data.begin(), data.end());
    ...
    PRINT("Test container(InputIt, InputIt, const KeyEqual&)");
    {
        ...
        sfl::static_unordered_linear_multiset<xint_xint, 100, std::equal_to<xint_xint>> set(data.begin(), data.end(), equal);
    ...
    PRINT("Test container(std::initializer_list)");
    {
        ...
        sfl::static_unordered_linear_multiset<xint_xint, 100, std::equal_to<xint_xint>> set(ilist);
    ...
    PRINT("Test container(std::initializer_list, const KeyEqual&)");
    {
        ...
        sfl::static_unordered_linear_multiset<xint_xint, 100, std::equal_to<xint_xint>> set(ilist, equal);
    ...
    {
        sfl::static_unordered_linear_multiset<xint_xint, 100, std::equal_to<xint_xint>> set1;
        ...
        sfl::static_unordered_linear_multiset<xint_xint, 100, std::equal_to<xint_xint>> set2(set1);
    ...
    PRINT("Test container(container&&)");
    {
        ...
        sfl::static_unordered_linear_multiset<xint_xint, 100, std::equal_to<xint_xint>> set2(std::move(set1));
    ...
    {
        sfl::static_unordered_linear_multiset<xint_xint, 100, std::equal_to<xint_xint>> set1, set2, set3;
    ...
    PRINT("Test NON-MEMBER erase_if(container&, Predicate)");
    {
        using container_type =
            sfl::static_unordered_linear_multiset<xint_xint, 100, std::equal_to<xint_xint>>;
...
int main()
{
    test_static_unordered_linear_multiset();
}
