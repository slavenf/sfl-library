//
// g++ -std=c++11 -g -O0 -Wall -Wextra -Wpedantic -Werror -Wfatal-errors -I ../include static_set.cpp
...
void test_static_set()
{
    ...
    {
        CHECK((sfl::static_set<xint_xint, 32, std::less<xint_xint>>::static_capacity == 32));
    }
    ...
    PRINT("Test container(const Compare&)");
    {
        ...
        sfl::static_set<xint_xint, 32, std::less<xint_xint>> set(comp);
    ...
    PRINT("Test container(InputIt, InputIt)");
    {
        ...
        sfl::static_set<xint_xint, 32, std::less<xint_xint>> set(data.begin(), data.end());
    ...
    PRINT("Test container(InputIt, InputIt, const Compare&)");
    {
        ...
        sfl::static_set<xint_xint, 32, std::less<xint_xint>> set(data.begin(), data.end(), comp);
    ...
    PRINT("Test container(std::initializer_list)");
    {
        ...
        sfl::static_set<xint_xint, 32, std::less<xint_xint>> set(ilist);
    ...
    PRINT("Test container(std::initializer_list, const Compare&)");
    {
        ...
        sfl::static_set<xint_xint, 32, std::less<xint_xint>> set(ilist, comp);
    ...
    {
        sfl::static_set<xint_xint, 32, std::less<xint_xint>> set1;
        ...
        sfl::static_set<xint_xint, 32, std::less<xint_xint>> set2(set1);
    ...
    PRINT("Test container(container&&)");
    {
        ...
        sfl::static_set<xint_xint, 32, std::less<xint_xint>> set2(std::move(set1));
    ...
    PRINT("Test container(sfl::from_range_t, Range&&)");
    {
        // Input iterator (exactly)
        {
            ...
            sfl::static_set<xint, 32, std::less<xint>> set
            (
                (sfl::from_range_t()),
    ...
    {
        sfl::static_set<xint_xint, 32, std::less<xint_xint>> set1, set2;
    ...
    PRINT("Test NON-MEMBER erase_if(container&, Predicate)");
    {
        using container_type =
            sfl::static_set<xint_xint, 32, std::less<xint_xint>>;
