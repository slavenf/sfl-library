...
#include "sfl/unordered_multiset.hpp"
...
void test_unordered_multiset_1()
{
    #undef   TPARAM_ALLOCATOR
    #define  TPARAM_ALLOCATOR std::allocator
    #include "unordered_multiset.inc"
}

void test_unordered_multiset_2()
{
    #undef   TPARAM_ALLOCATOR
...
void test_unordered_multiset_3()
{
    #undef   TPARAM_ALLOCATOR
...
void test_unordered_multiset_4()
{
    #undef   TPARAM_ALLOCATOR
...
void test_unordered_multiset_5()
{
    #undef   TPARAM_ALLOCATOR
...
int main()
{
    test_unordered_multiset_1();
    test_unordered_multiset_2();
    test_unordered_multiset_3();
    test_unordered_multiset_4();
    test_unordered_multiset_5();
}
