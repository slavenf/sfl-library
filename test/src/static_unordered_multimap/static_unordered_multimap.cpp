...
#include "sfl/static_unordered_multimap.hpp"
...
void test_static_unordered_multimap()
{
    using sfl::test::xint;
    using sfl::test::xobj;
    ...
    {
        CHECK((sfl::static_unordered_multimap<int, int, 32>::static_capacity == 32));
        CHECK((sfl::static_unordered_multimap<int, int, 32>::static_bucket_count == 32));
    }
    ...
    {
        sfl::static_unordered_multimap<xint, xint, 32> map;
    ...
    PRINT("Test container(const Hash&)");
    {
        ...
        sfl::static_unordered_multimap<xint, xint, 32> map(hash);
    ...
    PRINT("Test container(const Hash&, const KeyEqual&)");
    {
        ...
        sfl::static_unordered_multimap<xint, xint, 32> map(hash, equal);
    ...
    PRINT("Test container(InputIt, InputIt)");
    {
        ...
        sfl::static_unordered_multimap<xint, xint, 32> map(data.begin(), data.end());
    ...
    PRINT("Test container(InputIt, InputIt, const Hash&)");
    {
        ...
        sfl::static_unordered_multimap<xint, xint, 32> map(data.begin(), data.end(), hash);
    ...
    PRINT("Test container(InputIt, InputIt, const Hash&, const KeyEqual&)");
    {
        ...
        sfl::static_unordered_multimap<xint, xint, 32> map(data.begin(), data.end(), hash, equal);
    ...
    PRINT("Test container(std::initializer_list)");
    {
        ...
        sfl::static_unordered_multimap<xint, xint, 32> map(ilist);
    ...
    PRINT("Test container(std::initializer_list, const Hash&)");
    {
        ...
        sfl::static_unordered_multimap<xint, xint, 32> map(ilist, hash);
    ...
    PRINT("Test container(std::initializer_list, const Hash&, const KeyEqual&)");
    {
        ...
        sfl::static_unordered_multimap<xint, xint, 32> map(ilist, hash, equal);
    ...
    {
        sfl::static_unordered_multimap<xint, xint, 32> map1;
        ...
        CHECK(COUNT_KV(map1, 20, 2) == 1);
        CHECK(COUNT_KV(map1, 20, 3) == 1);
        CHECK(COUNT_KV(map1, 30, 1) == 1);

        ///////////////////////////////////////////////////////////////////////

        sfl::static_unordered_multimap<xint, xint, 32> map2(map1);

        CHECK(map2.size() == 5);
        CHECK(COUNT_KV(map2, 10, 1) == 1);
        CHECK(COUNT_KV(map2, 20, 1) == 1);
        CHECK(COUNT_KV(map2, 20, 2) == 1);
        CHECK(COUNT_KV(map2, 20, 3) == 1);
    ...
    PRINT("Test container(container&&)");
    {
        ...
        sfl::static_unordered_multimap<xint, xint, 32> map2(std::move(map1));
    ...
    {
        sfl::static_unordered_multimap<xint, xint, 32> map1, map2;
    ...
    PRINT("Test operator=(std::initializer_list)");
    {
        ...
        CHECK(COUNT_KV(map, 50, 3) == 1);
        CHECK(COUNT_KV(map, 50, 4) == 1);
    ...
    PRINT("Test hash_function()");
    {
        ...
        {
            sfl::static_unordered_multimap<xobj, xint, 32, 32, xobj::hash, xobj::equal> map;
    ...
    PRINT("Test equal_range, find, count, contains");
    {
        // xint, xint
        {
            ...
            CHECK(map.equal_range(40) == std::make_pair(map.find(40), std::next(map.find(40), 2)));
            CHECK(map.equal_range(50) == std::make_pair(map.end(), map.end()));
            CHECK(map.equal_range(60) == std::make_pair(map.find(60), std::next(map.find(60), 3)));
            ...
            CHECK(map.count(40) == 2);
            CHECK(map.count(50) == 0);
            CHECK(map.count(60) == 3);
    ...
    PRINT("Test NON-MEMBER erase_if(container&, Predicate)");
    {
        using container_type =
            sfl::static_unordered_multimap<xint, xint, 32>;
...
int main()
{
    test_static_unordered_multimap();
}
