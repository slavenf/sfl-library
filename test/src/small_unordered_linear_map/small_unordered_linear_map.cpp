...
void test_small_unordered_flat_map_1()
{
...
void test_small_unordered_flat_map_2()
{
    #undef   TPARAM_ALLOCATOR
...
void test_small_unordered_flat_map_3()
{
    #undef   TPARAM_ALLOCATOR
...
void test_small_unordered_flat_map_4()
{
    #undef   TPARAM_ALLOCATOR
...
void test_small_unordered_flat_map_5()
{
    #undef   TPARAM_ALLOCATOR
...
int main()
{
    test_small_unordered_flat_map_1();
    test_small_unordered_flat_map_2();
    test_small_unordered_flat_map_3();
    test_small_unordered_flat_map_4();
    test_small_unordered_flat_map_5();
}
