...
void test_static_unordered_set()
{
    using sfl::test::xint;
    ...
    {
        CHECK((sfl::static_unordered_set<int, 32>::static_capacity == 32));
        CHECK((sfl::static_unordered_set<int, 32>::static_bucket_count == 32));
    }
    ...
    {
        sfl::static_unordered_set<xint_xint, 32> set;
    ...
    PRINT("Test container(const Hash&)");
    {
        ...
        sfl::static_unordered_set<xint_xint, 32> set(hash);
    ...
    PRINT("Test container(const Hash&, const KeyEqual&)");
    {
        ...
        sfl::static_unordered_set<xint_xint, 32> set(hash, equal);
    ...
    PRINT("Test container(InputIt, InputIt)");
    {
        ...
        sfl::static_unordered_set<xint_xint, 32> set(data.begin(), data.end());
    ...
    PRINT("Test container(InputIt, InputIt, const Hash&)");
    {
        ...
        sfl::static_unordered_set<xint_xint, 32> set(data.begin(), data.end(), hash);
    ...
    PRINT("Test container(InputIt, InputIt, const Hash&, const KeyEqual&)");
    {
        ...
        sfl::static_unordered_set<xint_xint, 32> set(data.begin(), data.end(), hash, equal);
    ...
    PRINT("Test container(std::initializer_list)");
    {
        ...
        sfl::static_unordered_set<xint_xint, 32> set(ilist);
    ...
    PRINT("Test container(std::initializer_list, const Hash&)");
    {
        ...
        sfl::static_unordered_set<xint_xint, 32> set(ilist, hash);
    ...
    PRINT("Test container(std::initializer_list, const Hash&, const KeyEqual&)");
    {
        ...
        sfl::static_unordered_set<xint_xint, 32> set(ilist, hash, equal);
    ...
    {
        sfl::static_unordered_set<xint_xint, 32> set1;
        ...
        sfl::static_unordered_set<xint_xint, 32> set2(set1);
    ...
    PRINT("Test container(container&&)");
    {
        ...
        sfl::static_unordered_set<xint_xint, 32> set2(std::move(set1));
    ...
    {
        sfl::static_unordered_set<xint_xint, 32> set1, set2;
    ...
    {
        {
            sfl::static_unordered_set<xint, 32> set;
        ...
        {
            sfl::static_unordered_set<xobj, 32, 32, xobj::hash, xobj::equal> set;
    ...
    PRINT("Test NON-MEMBER erase_if(container&, Predicate)");
    {
        using container_type =
            sfl::static_unordered_set<xint_xint, 32>;
