//
// g++ -Wall -Wextra -Wpedantic -std=c++11 -g -I ../include -o test.out test_small_unordered_flat_multiset.cpp
...
int main()
{
            ...
            "member functions." << endl;
    {
        ...
        const sfl::small_unordered_flat_multiset<MyInt, 0, std::equal_to<MyInt>,
            TP_ALLOC<MyInt>
        > s2;

        sfl::small_unordered_flat_multiset<MyInt, 5, std::equal_to<MyInt>,
            TP_ALLOC<MyInt>
        > s3;

        const sfl::small_unordered_flat_multiset<MyInt, 5, std::equal_to<MyInt>,
            TP_ALLOC<MyInt>
        > s4;
    ...
    {
        sfl::small_unordered_flat_multiset<MyInt, 3, std::equal_to<MyInt>,
            TP_ALLOC<MyInt>
        > s;
    ...
    {
        sfl::small_unordered_flat_multiset<MyInt, 10, std::equal_to<MyInt>,
            TP_ALLOC<MyInt>
        > s;
    ...
    cout << "Test non-member erase_if(small_unordered_flat_multiset&, Predicate)." << endl;
    {
        ...
        using const_reference =
            typename sfl::small_unordered_flat_multiset<MyInt, 10, std::equal_to<MyInt>,
                TP_ALLOC<MyInt>
            >::const_reference;
