//
// g++ -Wall -Wextra -std=c++11 -g -I ../include -o test.out test_small_unordered_flat_multimap.cpp
...
int main()
{
    ...
    {
        sfl::small_unordered_flat_multimap<MyInt, MyString, 0> m1;
        const sfl::small_unordered_flat_multimap<MyInt, MyString, 0> m2;
        sfl::small_unordered_flat_multimap<MyInt, MyString, 5> m3;
        const sfl::small_unordered_flat_multimap<MyInt, MyString, 5> m4;
    ...
    {
        sfl::small_unordered_flat_multimap<Person, MyString, 0, PersonEqual> m1;
        const sfl::small_unordered_flat_multimap<Person, MyString, 0, PersonEqual> m2;
    ...
    {
        sfl::small_unordered_flat_multimap<MyInt, MyString, 3> m;
...

        {
            ...
            assert(m.capacity() == 3);
            assert(m.nth(0)->first == 10 && m.nth(0)->second == "/10.1/");
            assert(m.nth(1)->first == 10 && m.nth(1)->second == "/10.2/");
        }

        {
            ...
            assert(m.nth(0)->first == 10 && m.nth(0)->second == "/10.1/");
            assert(m.nth(1)->first == 10 && m.nth(1)->second == "/10.2/");
            assert(m.nth(2)->first == 20 && m.nth(2)->second == "/20.1/");
        }

        {
            ...
            assert(m.size() == 4);
            assert(m.capacity() == 6);
            assert(m.nth(0)->first == 20 && m.nth(0)->second == "/20.2/");
            assert(m.nth(1)->first == 10 && m.nth(1)->second == "/10.1/");
            assert(m.nth(2)->first == 10 && m.nth(2)->second == "/10.2/");
            assert(m.nth(3)->first == 20 && m.nth(3)->second == "/20.1/");
        }

        {
            ...
            assert(m.nth(2)->first == 10 && m.nth(2)->second == "/10.2/");
            assert(m.nth(3)->first == 20 && m.nth(3)->second == "/20.1/");
            assert(m.nth(4)->first == 15 && m.nth(4)->second == "/15.1/");
        }

        {
            ...
            assert(m.nth(3)->first == 20 && m.nth(3)->second == "/20.1/");
            assert(m.nth(4)->first == 15 && m.nth(4)->second == "/15.1/");
            assert(m.nth(5)->first == 15 && m.nth(5)->second == "/15.2/");
        }

        {
            ...
            assert(res == m.nth(0));
            assert(m.size() == 7);
            assert(m.capacity() == 12);
            assert(m.nth(0)->first == 30 && m.nth(0)->second == "/30.1/");
            assert(m.nth(1)->first == 20 && m.nth(1)->second == "/20.2/");
            assert(m.nth(2)->first == 10 && m.nth(2)->second == "/10.1/");
            assert(m.nth(3)->first == 10 && m.nth(3)->second == "/10.2/");
            assert(m.nth(4)->first == 20 && m.nth(4)->second == "/20.1/");
            assert(m.nth(5)->first == 15 && m.nth(5)->second == "/15.1/");
            assert(m.nth(6)->first == 15 && m.nth(6)->second == "/15.2/");
        }

        {
            ...
            assert(m.nth(5)->first == 15 && m.nth(5)->second == "/15.1/");
            assert(m.nth(6)->first == 15 && m.nth(6)->second == "/15.2/");
            assert(m.nth(7)->first == 30 && m.nth(7)->second == "/30.2/");
        }

        {
            ...
            assert(m.nth(6)->first == 15 && m.nth(6)->second == "/15.2/");
            assert(m.nth(7)->first == 30 && m.nth(7)->second == "/30.2/");
            assert(m.nth(8)->first == 16 && m.nth(8)->second == "/16.1/");
        }

        {
            ...
            assert(m.nth(7)->first == 30 && m.nth(7)->second == "/30.2/");
            assert(m.nth(8)->first == 16 && m.nth(8)->second == "/16.1/");
            assert(m.nth(9)->first == 16 && m.nth(9)->second == "/16.2/");
        }
    }

    cout << "Test emplace(Args&&...) (N == 0, with reallocation)." << endl;
    {
        sfl::small_unordered_flat_multimap<MyInt, MyString, 0> m;
...

        {
            ...
            assert(m.size() == 2);
            assert(m.capacity() == 2);
            assert(m.nth(0)->first == 10 && m.nth(0)->second == "/10.2/");
            assert(m.nth(1)->first == 10 && m.nth(1)->second == "/10.1/");
        }

        {
            ...
            assert(m.size() == 3);
            assert(m.capacity() == 4);
            assert(m.nth(0)->first == 20 && m.nth(0)->second == "/20.1/");
            assert(m.nth(1)->first == 10 && m.nth(1)->second == "/10.2/");
            assert(m.nth(2)->first == 10 && m.nth(2)->second == "/10.1/");
        }

        {
            ...
            assert(m.nth(1)->first == 10 && m.nth(1)->second == "/10.2/");
            assert(m.nth(2)->first == 10 && m.nth(2)->second == "/10.1/");
            assert(m.nth(3)->first == 20 && m.nth(3)->second == "/20.2/");
        }

        {
            ...
            assert(m.size() == 5);
            assert(m.capacity() == 8);
            assert(m.nth(0)->first == 15 && m.nth(0)->second == "/15.1/");
            assert(m.nth(1)->first == 20 && m.nth(1)->second == "/20.1/");
            assert(m.nth(2)->first == 10 && m.nth(2)->second == "/10.2/");
            assert(m.nth(3)->first == 10 && m.nth(3)->second == "/10.1/");
            assert(m.nth(4)->first == 20 && m.nth(4)->second == "/20.2/");
        }
...

        {
            ...
            assert(m.nth(4)->first == 20 && m.nth(4)->second == "/20.2/");
            assert(m.nth(5)->first == 15 && m.nth(5)->second == "/15.2/");
            assert(m.nth(6)->first == 30 && m.nth(6)->second == "/30.1/");
        }
...

        {
            ...
            assert(m.nth(0)->first == 16 && m.nth(0)->second == "/16.1/");
            assert(m.nth(1)->first == 15 && m.nth(1)->second == "/15.1/");
            assert(m.nth(2)->first == 20 && m.nth(2)->second == "/20.1/");
            assert(m.nth(3)->first == 10 && m.nth(3)->second == "/10.2/");
            assert(m.nth(4)->first == 10 && m.nth(4)->second == "/10.1/");
            assert(m.nth(5)->first == 20 && m.nth(5)->second == "/20.2/");
            assert(m.nth(6)->first == 15 && m.nth(6)->second == "/15.2/");
            assert(m.nth(7)->first == 30 && m.nth(7)->second == "/30.1/");
            assert(m.nth(8)->first == 30 && m.nth(8)->second == "/30.2/");
        }
    ...
    {
        sfl::small_unordered_flat_multimap<MyInt, MyString, 10> m;
    ...
    {
        sfl::small_unordered_flat_multimap<Person, MyString, 10, PersonEqual> m;
...

        {
            ...
            assert(m.find(Person(30, "xxx")) == m.nth(3));
...

        {
            ...
            assert(m.count(Person(20, "xxx")) == 2);
    ...
    cout << "Test insert(const value_type&)." << endl;
    {
        ...
        {
            const std::pair<MyInt, MyString> v(10, "/10.2/");
    ...
    cout << "Test insert(value_type&&)." << endl;
    {
        ...
        {
            std::pair<MyInt, MyString> v(10, "/10.2/");
    ...
    cout << "Test erase(const Key&)." << endl;
    {
...

        {
            ...
            assert(m.nth(4)->first == 10 && m.nth(4)->second == "/10/");
            assert(m.nth(5)->first == 30 && m.nth(5)->second == "/30/");
            assert(m.nth(6)->first == 40 && m.nth(6)->second == "/40/");
            assert(m.nth(7)->first == 10 && m.nth(7)->second == "/10/");
        }
    ...
    {
        sfl::small_unordered_flat_multimap<Person, MyString, 10, PersonEqual> s;
    ...
    cout << "Test swap(small_unordered_flat_map&)." << endl;
    {
        ...
        {
            sfl::small_unordered_flat_multimap<MyInt, MyString, 5> m1;
            sfl::small_unordered_flat_multimap<MyInt, MyString, 5> m2;
    ...
    {
        sfl::small_unordered_flat_multimap<MyInt, MyString, 5> m;
    ...
    cout << "Test empty constructors." << endl;
    {
        ...
        sfl::small_unordered_flat_multimap<MyInt, MyString, 10> m1;
        sfl::small_unordered_flat_multimap<MyInt, MyString, 10> m2(eq);
        sfl::small_unordered_flat_multimap<MyInt, MyString, 10> m3(alloc);
        sfl::small_unordered_flat_multimap<MyInt, MyString, 10> m4(eq, alloc);
    ...
    cout << "Test range constructors." << endl;
    {
        ...
        sfl::small_unordered_flat_multimap<MyInt, MyString, 10> m1(v.begin(), v.end());
        sfl::small_unordered_flat_multimap<MyInt, MyString, 10> m2(v.begin(), v.end(), eq);
        sfl::small_unordered_flat_multimap<MyInt, MyString, 10> m3(v.begin(), v.end(), alloc);
        sfl::small_unordered_flat_multimap<MyInt, MyString, 10> m4(v.begin(), v.end(), eq, alloc);
        ...
        assert(m1.nth(3)->first == 10 && m1.nth(3)->second == "/10/");
        assert(m1.nth(4)->first == 20 && m1.nth(4)->second == "/20/");
        ...
        assert(m2.nth(3)->first == 10 && m2.nth(3)->second == "/10/");
        assert(m2.nth(4)->first == 20 && m2.nth(4)->second == "/20/");
        ...
        assert(m3.nth(3)->first == 10 && m3.nth(3)->second == "/10/");
        assert(m3.nth(4)->first == 20 && m3.nth(4)->second == "/20/");

        assert(m4.size() == 5);
        assert(m4.capacity() == 10);
        assert(m4.nth(0)->first == 30 && m4.nth(0)->second == "/30/");
        assert(m4.nth(1)->first == 20 && m4.nth(1)->second == "/20/");
        assert(m4.nth(2)->first == 10 && m4.nth(2)->second == "/10/");
        assert(m4.nth(3)->first == 10 && m4.nth(3)->second == "/10/");
        assert(m4.nth(4)->first == 20 && m4.nth(4)->second == "/20/");
    }
    ...
    cout << "Test initializer_list constructors." << endl;
    {
        ...
        sfl::small_unordered_flat_multimap<MyInt, MyString, 10> m2
        (
            {
                {30, "/30/"},
                {20, "/20/"},
        ...
        sfl::small_unordered_flat_multimap<MyInt, MyString, 10> m3
        (
            {
                {30, "/30/"},
                {20, "/20/"},
        ...
        sfl::small_unordered_flat_multimap<MyInt, MyString, 10> m4
        (
            {
                {30, "/30/"},
                {20, "/20/"},
    ...
    cout << "Test copy constructors (N > 0)." << endl;
    {
        ...
        sfl::small_unordered_flat_multimap<MyInt, MyString, 10> m2(m1);

        sfl::small_unordered_flat_multimap<MyInt, MyString, 10> m3(m1, std::allocator<MyInt>());
    ...
    cout << "Test copy constructors (N == 0)." << endl;
    {
        ...
        sfl::small_unordered_flat_multimap<MyInt, MyString, 0> m2(m1);

        sfl::small_unordered_flat_multimap<MyInt, MyString, 0> m3(m1, std::allocator<MyInt>());
    ...
    cout << "Test move constructors (N > 0)." << endl;
    {
        ...
        sfl::small_unordered_flat_multimap<MyInt, MyString, 10> m2(std::move(m1));
        ...
        sfl::small_unordered_flat_multimap<MyInt, MyString, 10> m3(std::move(m2), std::allocator<MyInt>());
    ...
    cout << "Test move constructors (N == 0)." << endl;
    {
        ...
        sfl::small_unordered_flat_multimap<MyInt, MyString, 0> m2(std::move(m1));
        ...
        sfl::small_unordered_flat_multimap<MyInt, MyString, 0> m3(std::move(m2), std::allocator<MyInt>());
    ...
    cout << "Test move assignment operator (N == 0)." << endl;
    {
        ...
        sfl::small_unordered_flat_multimap<MyInt, MyString, 0> m2
        (
            {
                {20, "/20/"},
                {21, "/21/"}
        ...
        sfl::small_unordered_flat_multimap<MyInt, MyString, 0> m3
        (
            {
                {30, "/30/"},
                {31, "/31/"}
    ...
    cout << "Test initializer_list assignment operator." << endl;
    {
        ...
        assert(m1.size() == 5);
        assert(m1.capacity() == 5);
        assert(m1.nth(0)->first == 22 && m1.nth(0)->second == "/22/");
        assert(m1.nth(1)->first == 21 && m1.nth(1)->second == "/21/");
        assert(m1.nth(2)->first == 20 && m1.nth(2)->second == "/20/");
        assert(m1.nth(3)->first == 20 && m1.nth(3)->second == "/20/");
        assert(m1.nth(4)->first == 21 && m1.nth(4)->second == "/21/");
    }

    cout << "Test non-member comparison operators." << endl;
    {
        sfl::small_unordered_flat_multimap<int, char, 5> m1
        (
            {
                {1, 'a'},
                {2, 'b'},
        ...
        sfl::small_unordered_flat_multimap<int, char, 5> m2
        (
            {
                {1, 'a'},
                {2, 'b'},
    ...
    cout << "Test non-member erase_if(small_unordered_flat_multimap&, Predicate)." << endl;
    {
        ...
        using const_reference =
            typename sfl::small_unordered_flat_multimap<MyInt, MyString, 10>::const_reference;

        assert(m1.size() == 4);
        assert(m1.nth(0)->first == 10 && m1.nth(0)->second == "/10/");
        assert(m1.nth(1)->first == 20 && m1.nth(1)->second == "/20/");
        assert(m1.nth(2)->first == 20 && m1.nth(2)->second == "/20/");
        assert(m1.nth(3)->first == 30 && m1.nth(3)->second == "/30/");
