//
// g++ -Wall -Wextra -Wpedantic -std=c++11 -g -I ../include -o test.out test_small_unordered_flat_multimap.cpp
...
int main()
{
    ...
    {
        sfl::small_unordered_flat_multimap<MyInt, MyString, 0, std::equal_to<MyInt>,
            TP_ALLOC<std::pair<MyInt, MyString>>
        > m1;

        const sfl::small_unordered_flat_multimap<MyInt, MyString, 0, std::equal_to<MyInt>,
            TP_ALLOC<std::pair<MyInt, MyString>>
        > m2;

        sfl::small_unordered_flat_multimap<MyInt, MyString, 5, std::equal_to<MyInt>,
            TP_ALLOC<std::pair<MyInt, MyString>>
        > m3;

        const sfl::small_unordered_flat_multimap<MyInt, MyString, 5, std::equal_to<MyInt>,
            TP_ALLOC<std::pair<MyInt, MyString>>
        > m4;
    ...
    {
        sfl::small_unordered_flat_multimap<Person, MyString, 0, PersonEqual,
            TP_ALLOC<std::pair<Person, MyString>>
        > m1;

        const sfl::small_unordered_flat_multimap<Person, MyString, 0, PersonEqual,
            TP_ALLOC<std::pair<Person, MyString>>
        > m2;
    ...
    {
        sfl::small_unordered_flat_multimap<MyInt, MyString, 3, std::equal_to<MyInt>,
            TP_ALLOC<std::pair<MyInt, MyString>>
        > m;
    ...
    {
        sfl::small_unordered_flat_multimap<MyInt, MyString, 10, std::equal_to<MyInt>,
            TP_ALLOC<std::pair<MyInt, MyString>>
        > m;
    ...
    {
        sfl::small_unordered_flat_multimap<Person, MyString, 10, PersonEqual,
            TP_ALLOC<std::pair<Person, MyString>>
        > m;
    ...
    cout << "Test non-member erase_if(small_unordered_flat_multimap&, Predicate)." << endl;
    {
        ...
        using const_reference =
            typename sfl::small_unordered_flat_multimap<MyInt, MyString, 10, std::equal_to<MyInt>,
                TP_ALLOC<std::pair<MyInt, MyString>>
            >::const_reference;
