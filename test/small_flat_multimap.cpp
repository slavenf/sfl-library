...
int main()
{
    ...
    {
        sfl::small_flat_multimap<xint, xstr, 0, std::less<xint>,
            TPARAM_ALLOCATOR<std::pair<xint, xstr>>
        > m1;

        const sfl::small_flat_multimap<xint, xstr, 0, std::less<xint>,
            TPARAM_ALLOCATOR<std::pair<xint, xstr>>
        > m2;

        sfl::small_flat_multimap<xint, xstr, 5, std::less<xint>,
            TPARAM_ALLOCATOR<std::pair<xint, xstr>>
        > m3;

        const sfl::small_flat_multimap<xint, xstr, 5, std::less<xint>,
            TPARAM_ALLOCATOR<std::pair<xint, xstr>>
        > m4;
    ...
    {
        sfl::small_flat_multimap<Person, xstr, 0, PersonLess,
            TPARAM_ALLOCATOR<std::pair<Person, xstr>>
        > m1;
        const sfl::small_flat_multimap<Person, xstr, 0, PersonLess,
            TPARAM_ALLOCATOR<std::pair<Person, xstr>>
        > m2;
    ...
    {
        sfl::small_flat_multimap<xint, xstr, 3, std::less<xint>,
            TPARAM_ALLOCATOR<std::pair<xint, xstr>>
        > m;
...

        {
            ...
            CHECK(m.nth(1)->first == 15 && m.nth(1)->second == "/15/");
            CHECK(m.nth(2)->first == 16 && m.nth(2)->second == "-16-");
            CHECK(m.nth(3)->first == 16 && m.nth(3)->second == "/16/");
            CHECK(m.nth(4)->first == 20 && m.nth(4)->second == "/20/");
...

        {
            ...
            CHECK(m.nth(2)->first == 15 && m.nth(2)->second == "/15/");
            CHECK(m.nth(3)->first == 16 && m.nth(3)->second == "-16-");
            CHECK(m.nth(4)->first == 16 && m.nth(4)->second == "/16/");
            CHECK(m.nth(5)->first == 20 && m.nth(5)->second == "/20/");
            CHECK(m.nth(6)->first == 30 && m.nth(6)->second == "/30/");
        }
    }
    ...
    {
        sfl::small_flat_multimap<xint, xstr, 10, std::less<xint>,
            TPARAM_ALLOCATOR<std::pair<xint, xstr>>
        > m;
...

        {
            ...
            CHECK(m.lower_bound(30) == m.nth(3));
        }

        {
            CHECK(m.upper_bound(10) == m.nth(1));
            CHECK(m.upper_bound(20) == m.nth(3));
            CHECK(m.upper_bound(30) == m.nth(4));
        }

        {
            CHECK(m.equal_range(10) == std::make_pair(m.nth(0), m.nth(1)));
            CHECK(m.equal_range(20) == std::make_pair(m.nth(1), m.nth(3)));
            CHECK(m.equal_range(30) == std::make_pair(m.nth(3), m.nth(4)));
    ...
    {
        sfl::small_flat_multimap<Person, xstr, 10, PersonLess,
            TPARAM_ALLOCATOR<std::pair<Person, xstr>>
        > m;
...

        {
            ...
            CHECK(m.lower_bound(Person(30, "xxx")) == m.nth(3));
        }
...

        {
            ...
            CHECK(m.upper_bound(Person(20, "xxx")) == m.nth(3));
            CHECK(m.upper_bound(Person(30, "xxx")) == m.nth(4));
        }
...

        {
            ...
            CHECK(m.equal_range(Person(20, "xxx")) == std::make_pair(m.nth(1), m.nth(3)));
            CHECK(m.equal_range(Person(30, "xxx")) == std::make_pair(m.nth(3), m.nth(4)));
    ...
    cout << "Test emplace(const_iterator, Args&&...)." << endl;
    {
...

        {
            ...
            CHECK(m.nth(2)->first == 20 && m.nth(2)->second == "/20/");
            CHECK(m.nth(3)->first == 30 && m.nth(3)->second == "/30/");
            CHECK(m.nth(4)->first == 40 && m.nth(4)->second == "/40/");
        }

        {
            ...
            CHECK(m.nth(3)->first == 20 && m.nth(3)->second == "/20/");
            CHECK(m.nth(4)->first == 30 && m.nth(4)->second == "/30/");
            CHECK(m.nth(5)->first == 40 && m.nth(5)->second == "/40/");
        }
    ...
    cout << "Test insert(const value_type&)." << endl;
    {
...

        {
            ...
            CHECK(m.nth(3)->first == 15 && m.nth(3)->second == "/15/");
            CHECK(m.nth(4)->first == 20 && m.nth(4)->second == "/20/");
        }
    }
    ...
    cout << "Test insert(const_iterator, const value_type&)." << endl;
    {
        ...
        {
            const std::pair<xint, xstr> v(40, "/40/");
    ...
    cout << "Test range constructors." << endl;
    {
        ...
        CHECK(m1.nth(5)->first == 30 && m1.nth(5)->second == "/30/");

        CHECK(m2.size() == 6);
        CHECK(m2.capacity() == 10);
        CHECK(m2.nth(0)->first == 10 && m2.nth(0)->second == "*10*");
        CHECK(m2.nth(1)->first == 10 && m2.nth(1)->second == "/10/");
        CHECK(m2.nth(2)->first == 20 && m2.nth(2)->second == "-20-");
        CHECK(m2.nth(3)->first == 20 && m2.nth(3)->second == "*20*");
        CHECK(m2.nth(4)->first == 20 && m2.nth(4)->second == "/20/");
        CHECK(m2.nth(5)->first == 30 && m2.nth(5)->second == "/30/");

        CHECK(m3.size() == 6);
        CHECK(m3.capacity() == 10);
        CHECK(m3.nth(0)->first == 10 && m3.nth(0)->second == "*10*");
        CHECK(m3.nth(1)->first == 10 && m3.nth(1)->second == "/10/");
        CHECK(m3.nth(2)->first == 20 && m3.nth(2)->second == "-20-");
        CHECK(m3.nth(3)->first == 20 && m3.nth(3)->second == "*20*");
        CHECK(m3.nth(4)->first == 20 && m3.nth(4)->second == "/20/");
        CHECK(m3.nth(5)->first == 30 && m3.nth(5)->second == "/30/");

        CHECK(m4.size() == 6);
        CHECK(m4.capacity() == 10);
        CHECK(m4.nth(0)->first == 10 && m4.nth(0)->second == "*10*");
        CHECK(m4.nth(1)->first == 10 && m4.nth(1)->second == "/10/");
        CHECK(m4.nth(2)->first == 20 && m4.nth(2)->second == "-20-");
        CHECK(m4.nth(3)->first == 20 && m4.nth(3)->second == "*20*");
        CHECK(m4.nth(4)->first == 20 && m4.nth(4)->second == "/20/");
        CHECK(m4.nth(5)->first == 30 && m4.nth(5)->second == "/30/");
    }
    ...
    cout << "Test non-member erase_if(small_flat_multimap&, Predicate)." << endl;
    {
        ...
        using const_reference =
            typename sfl::small_flat_multimap<xint, xstr, 10, std::less<xint>,
                TPARAM_ALLOCATOR<std::pair<xint, xstr>>
            >::const_reference;
