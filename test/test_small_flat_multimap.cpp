//
// g++ -Wall -Wextra -std=c++11 -g -I ../include -o test.out test_small_flat_multimap.cpp
...
int main()
{
    ...
    {
        sfl::small_flat_multimap<MyInt, MyString, 0> m1;
        const sfl::small_flat_multimap<MyInt, MyString, 0> m2;
        sfl::small_flat_multimap<MyInt, MyString, 5> m3;
        const sfl::small_flat_multimap<MyInt, MyString, 5> m4;
    ...
    {
        sfl::small_flat_multimap<Person, MyString, 0, PersonLess> m1;
        const sfl::small_flat_multimap<Person, MyString, 0, PersonLess> m2;
    ...
    {
        sfl::small_flat_multimap<MyInt, MyString, 3> m;
...

        {
            ...
            assert(m.nth(1)->first == 15 && m.nth(1)->second == "/15/");
            assert(m.nth(2)->first == 16 && m.nth(2)->second == "-16-");
            assert(m.nth(3)->first == 16 && m.nth(3)->second == "/16/");
            assert(m.nth(4)->first == 20 && m.nth(4)->second == "/20/");
...

        {
            ...
            assert(m.nth(5)->first == 20 && m.nth(5)->second == "/20/");
            assert(m.nth(6)->first == 30 && m.nth(6)->second == "/30/");
        }
    }

    cout << "Test emplace(Args&&...) (N == 0, with reallocation)." << endl;
    {
        sfl::small_flat_multimap<MyInt, MyString, 0> m;
    ...
    {
        sfl::small_flat_multimap<MyInt, MyString, 10> m;
...

        {
            ...
            assert(m.lower_bound(30) == m.nth(3));
        }

        {
            assert(m.upper_bound(10) == m.nth(1));
            assert(m.upper_bound(20) == m.nth(3));
            assert(m.upper_bound(30) == m.nth(4));
        }

        {
            assert(m.equal_range(10) == std::make_pair(m.nth(0), m.nth(1)));
            assert(m.equal_range(20) == std::make_pair(m.nth(1), m.nth(3)));
            assert(m.equal_range(30) == std::make_pair(m.nth(3), m.nth(4)));
    ...
    {
        sfl::small_flat_multimap<Person, MyString, 10, PersonLess> m;
...

        {
            ...
            assert(m.lower_bound(Person(30, "xxx")) == m.nth(3));
        }
...

        {
            ...
            assert(m.upper_bound(Person(20, "xxx")) == m.nth(3));
            assert(m.upper_bound(Person(30, "xxx")) == m.nth(4));
        }
...

        {
            ...
            assert(m.equal_range(Person(20, "xxx")) == std::make_pair(m.nth(1), m.nth(3)));
            assert(m.equal_range(Person(30, "xxx")) == std::make_pair(m.nth(3), m.nth(4)));
    ...
    cout << "Test emplace(const_iterator, Args&&...)." << endl;
    {
...

        {
            cout << ">" << endl;
            // good hint
            auto res = m.emplace_hint(m.nth(1), 30, "/30/");
            cout << "<" << endl;
...

        {
            cout << ">" << endl;
            // bad hint
            auto res = m.emplace_hint(m.nth(1), 40, "/40/");
            cout << "<" << endl;
...

        {
            ...
            assert(m.nth(2)->first == 20 && m.nth(2)->second == "/20/");
            assert(m.nth(3)->first == 30 && m.nth(3)->second == "/30/");
            assert(m.nth(4)->first == 40 && m.nth(4)->second == "/40/");
        }

        {
            cout << ">" << endl;
            // good hint
            auto res = m.emplace_hint(m.nth(2), 20, "-20-");
            cout << "<" << endl;
            ...
            assert(m.nth(3)->first == 20 && m.nth(3)->second == "/20/");
            assert(m.nth(4)->first == 30 && m.nth(4)->second == "/30/");
            assert(m.nth(5)->first == 40 && m.nth(5)->second == "/40/");
        }

        {
            cout << ">" << endl;
            // good hint
            auto res = m.emplace_hint(m.nth(4), 20, "+20+");
            cout << "<" << endl;
    ...
    cout << "Test insert(const_iterator, const value_type&)." << endl;
    {
        ...
        {
            const std::pair<MyInt, MyString> v(40, "/40/");
    ...
    cout << "Test insert(const_iterator, value_type&&)." << endl;
    {
        ...
        {
            std::pair<MyInt, MyString> v(40, "/40/");
...

        {
            ...
            cout << ">" << endl;
            // good hint
            auto res = m.insert(m.nth(2), std::move(v));
            cout << "<" << endl;
...

        {
            ...
            cout << ">" << endl;
            // good hint
            auto res = m.insert(m.nth(4), std::move(v));
            cout << "<" << endl;
    ...
    cout << "Test insert(const_iterator, P&&...)." << endl;
    {
...

        {
            cout << ">" << endl;
            // good hint
            auto res = m.insert(m.nth(1), std::make_pair(30, "/30/"));
            cout << "<" << endl;
...

        {
            cout << ">" << endl;
            // good hint
            auto res = m.insert(m.nth(1), std::make_pair(20, "/20/"));
            cout << "<" << endl;
...

        {
            cout << ">" << endl;
            // bad hint
            auto res = m.insert(m.nth(1), std::make_pair(40, "/40/"));
            cout << "<" << endl;
...

        {
            cout << ">" << endl;
            // good hint
            auto res = m.insert(m.nth(2), std::make_pair(20, "-20-"));
            cout << "<" << endl;
...

        {
            cout << ">" << endl;
            // good hint
            auto res = m.insert(m.nth(4), std::make_pair(20, "+20+"));
            cout << "<" << endl;
    ...
    cout << "Test swap(small_flat_multimap&)." << endl;
    {
        // m1 uses internal storage, m2 uses internal storage
        {
            sfl::small_flat_multimap<MyInt, MyString, 5> m1;
            sfl::small_flat_multimap<MyInt, MyString, 5> m2;
    ...
    {
        sfl::small_flat_multimap<MyInt, MyString, 5> m;
    ...
    cout << "Test empty constructors." << endl;
    {
        ...
        sfl::small_flat_multimap<MyInt, MyString, 10> m1;
        sfl::small_flat_multimap<MyInt, MyString, 10> m2(comp);
        sfl::small_flat_multimap<MyInt, MyString, 10> m3(alloc);
        sfl::small_flat_multimap<MyInt, MyString, 10> m4(comp, alloc);
    ...
    cout << "Test range constructors." << endl;
    {
        ...
        sfl::small_flat_multimap<MyInt, MyString, 10> m1(v.begin(), v.end());
        sfl::small_flat_multimap<MyInt, MyString, 10> m2(v.begin(), v.end(), comp);
        sfl::small_flat_multimap<MyInt, MyString, 10> m3(v.begin(), v.end(), alloc);
        sfl::small_flat_multimap<MyInt, MyString, 10> m4(v.begin(), v.end(), comp, alloc);
        ...
        assert(m1.nth(5)->first == 30 && m1.nth(5)->second == "/30/");

        assert(m2.size() == 6);
        assert(m2.capacity() == 10);
        assert(m2.nth(0)->first == 10 && m2.nth(0)->second == "*10*");
        assert(m2.nth(1)->first == 10 && m2.nth(1)->second == "/10/");
        assert(m2.nth(2)->first == 20 && m2.nth(2)->second == "-20-");
        assert(m2.nth(3)->first == 20 && m2.nth(3)->second == "*20*");
        assert(m2.nth(4)->first == 20 && m2.nth(4)->second == "/20/");
        assert(m2.nth(5)->first == 30 && m2.nth(5)->second == "/30/");

        assert(m3.size() == 6);
        assert(m3.capacity() == 10);
        assert(m3.nth(0)->first == 10 && m3.nth(0)->second == "*10*");
        assert(m3.nth(1)->first == 10 && m3.nth(1)->second == "/10/");
        assert(m3.nth(2)->first == 20 && m3.nth(2)->second == "-20-");
        assert(m3.nth(3)->first == 20 && m3.nth(3)->second == "*20*");
        assert(m3.nth(4)->first == 20 && m3.nth(4)->second == "/20/");
        assert(m3.nth(5)->first == 30 && m3.nth(5)->second == "/30/");

        assert(m4.size() == 6);
        assert(m4.capacity() == 10);
        assert(m4.nth(0)->first == 10 && m4.nth(0)->second == "*10*");
        assert(m4.nth(1)->first == 10 && m4.nth(1)->second == "/10/");
        assert(m4.nth(2)->first == 20 && m4.nth(2)->second == "-20-");
        assert(m4.nth(3)->first == 20 && m4.nth(3)->second == "*20*");
        assert(m4.nth(4)->first == 20 && m4.nth(4)->second == "/20/");
        assert(m4.nth(5)->first == 30 && m4.nth(5)->second == "/30/");
    }
    ...
    cout << "Test initializer_list constructors." << endl;
    {
        ...
        sfl::small_flat_multimap<MyInt, MyString, 10> m2
        (
            {
                {10, "/10/"},
                {30, "/30/"},
        ...
        sfl::small_flat_multimap<MyInt, MyString, 10> m3
        (
            {
                {10, "/10/"},
                {30, "/30/"},
        ...
        sfl::small_flat_multimap<MyInt, MyString, 10> m4
        (
            {
                {10, "/10/"},
                {30, "/30/"},
    ...
    cout << "Test copy constructors (N > 0)." << endl;
    {
        ...
        sfl::small_flat_multimap<MyInt, MyString, 10> m2(m1);

        sfl::small_flat_multimap<MyInt, MyString, 10> m3(m1, std::allocator<MyInt>());
    ...
    cout << "Test copy constructors (N == 0)." << endl;
    {
        ...
        sfl::small_flat_multimap<MyInt, MyString, 0> m2(m1);

        sfl::small_flat_multimap<MyInt, MyString, 0> m3(m1, std::allocator<MyInt>());
    ...
    cout << "Test move constructors (N > 0)." << endl;
    {
        ...
        sfl::small_flat_multimap<MyInt, MyString, 10> m2(std::move(m1));
        ...
        sfl::small_flat_multimap<MyInt, MyString, 10> m3(std::move(m2), std::allocator<MyInt>());
    ...
    cout << "Test move constructors (N == 0)." << endl;
    {
        ...
        sfl::small_flat_multimap<MyInt, MyString, 0> m2(std::move(m1));
        ...
        sfl::small_flat_multimap<MyInt, MyString, 0> m3(std::move(m2), std::allocator<MyInt>());
    ...
    cout << "Test move assignment operator (N == 0)." << endl;
    {
        ...
        sfl::small_flat_multimap<MyInt, MyString, 0> m2
        (
            {
                {20, "/20/"},
                {21, "/21/"}
        ...
        sfl::small_flat_multimap<MyInt, MyString, 0> m3
        (
            {
                {30, "/30/"},
                {31, "/31/"}
    ...
    {
        sfl::small_flat_multimap<int, char, 5> m1
        (
            {
                {1, 'a'},
                {2, 'b'},
        ...
        sfl::small_flat_multimap<int, char, 5> m2
        (
            {
                {1, 'a'},
                {2, 'b'},
    ...
    cout << "Test non-member erase_if(small_flat_multimap&, Predicate)." << endl;
    {
        sfl::small_flat_multimap<MyInt, MyString, 10> m1
        (
            {
        ...
        using const_reference =
            typename sfl::small_flat_multimap<MyInt, MyString, 10>::const_reference;
