//
// g++ -Wall -Wextra -std=c++11 -g -I ../include -o test.out test_small_vector.cpp
...
int main()
{
            ...
            "member functions." << endl;
    {
        ...
        const sfl::small_vector<MyInt, 0> v2;
        sfl::small_vector<MyInt, 5> v3;
        const sfl::small_vector<MyInt, 5> v4;
        ...
        assert(v1.data() == v1.begin());
        assert(v2.data() == v2.begin());
        assert(v3.data() == v3.begin());
        assert(v4.data() == v4.begin());
    }
    ...
    cout << "Test swap(small_vector&)." << endl;
    {
        // v1 uses internal storage, v2 uses internal storage
        {
            ...
            sfl::small_vector<MyInt, 5> v2({20, 21, 22, 23});
        ...
        {
            sfl::small_vector<MyInt, 5> v1({10, 11, 12});
            sfl::small_vector<MyInt, 5> v2({20, 21, 22, 23, 24, 25});
        ...
        {
            sfl::small_vector<MyInt, 5> v1({10, 11, 12, 13, 14, 15});
    ...
    cout << "Test constructor()." << endl;
    {
        ...
        sfl::small_vector<MyInt, 10> v2(alloc);
    ...
    cout << "Test constructor(size_type)." << endl;
    {
        ...
        sfl::small_vector<MyInt, 10> v1(3);
        sfl::small_vector<MyInt, 10> v2(3, alloc);
    ...
    {
        sfl::small_vector<MyInt, 10> v1({10, 20, 30, 40, 50});

        sfl::small_vector<MyInt, 10> v2(v1);

        sfl::small_vector<MyInt, 10> v3(v1, std::allocator<MyInt>());
    ...
    cout << "Test copy constructors (N == 0)." << endl;
    {
        sfl::small_vector<MyInt, 0> v1({10, 20, 30, 40, 50});

        sfl::small_vector<MyInt, 0> v2(v1);

        sfl::small_vector<MyInt, 0> v3(v1, std::allocator<MyInt>());
    ...
    cout << "Test move constructors (N > 0)." << endl;
    {
        ...
        sfl::small_vector<MyInt, 10> v2(std::move(v1));
        ...
        sfl::small_vector<MyInt, 10> v3(std::move(v2), std::allocator<MyInt>());
    ...
    cout << "Test move constructors (N == 0)." << endl;
    {
        ...
        sfl::small_vector<MyInt, 0> v2(std::move(v1));
        ...
        sfl::small_vector<MyInt, 0> v3(std::move(v2), std::allocator<MyInt>());
    ...
    cout << "Test operator=(const small_vector&)." << endl;
    {
        // n <= capacity && n <= size
        {
            ...
            sfl::small_vector<MyInt, 5> v2({21, 22});
        ...
        {
            sfl::small_vector<MyInt, 5> v1({11, 12, 13});
            sfl::small_vector<MyInt, 5> v2({21, 22, 23, 24, 25});
        ...
        {
            sfl::small_vector<MyInt, 5> v1({11, 12, 13});
            sfl::small_vector<MyInt, 5> v2({21, 22, 23, 24, 25, 26});
    ...
    {
        sfl::small_vector<MyInt, 10> v1({10, 20, 20, 30, 30, 30});
