...
#ifndef SFL_DETAIL_STATIC_NODE_ALLOCATOR_HPP_INCLUDED
#define SFL_DETAIL_STATIC_NODE_ALLOCATOR_HPP_INCLUDED
...
public:
    ...
    struct rebind
    {
        using other = static_node_allocator<U, N>;
    };
...
(
    ...
    const static_node_allocator<T2, N>& y
) noexcept
{
...
#endif // SFL_DETAIL_STATIC_NODE_ALLOCATOR_HPP_INCLUDED
