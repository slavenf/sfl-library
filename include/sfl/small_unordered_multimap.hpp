...
#ifndef SFL_SMALL_UNORDERED_MULTIMAP_HPP_INCLUDED
...
public:
    ...
    small_unordered_multimap(size_type bucket_count, const Allocator& alloc)
        : hash_table_(calculate_initial_bucket_count(bucket_count), alloc)
    {}

    small_unordered_multimap(size_type bucket_count, const Hash& hash)
        : hash_table_(calculate_initial_bucket_count(bucket_count), hash)
    {}

    small_unordered_multimap(size_type bucket_count, const Hash& hash, const Allocator& alloc)
        : hash_table_(calculate_initial_bucket_count(bucket_count), hash, alloc)
    {}

    small_unordered_multimap(size_type bucket_count, const Hash& hash, const KeyEqual& equal)
        : hash_table_(calculate_initial_bucket_count(bucket_count), hash, equal)
    {}

    small_unordered_multimap(size_type bucket_count, const Hash& hash, const KeyEqual& equal, const Allocator& alloc)
    ...
    small_unordered_multimap(std::initializer_list<value_type> ilist)
        : small_unordered_multimap(ilist.begin(), ilist.end())
    {}

    small_unordered_multimap(std::initializer_list<value_type> ilist, size_type bucket_count)
        : small_unordered_multimap(ilist.begin(), ilist.end(), bucket_count)
    {}

    small_unordered_multimap(std::initializer_list<value_type> ilist, size_type bucket_count, const Allocator& alloc)
        : small_unordered_multimap(ilist.begin(), ilist.end(), bucket_count, alloc)
    {}

    small_unordered_multimap(std::initializer_list<value_type> ilist, size_type bucket_count, const Hash& hash)
        : small_unordered_multimap(ilist.begin(), ilist.end(), bucket_count, hash)
    {}

    small_unordered_multimap(std::initializer_list<value_type> ilist, size_type bucket_count, const Hash& hash, const Allocator& alloc)
        : small_unordered_multimap(ilist.begin(), ilist.end(), bucket_count, hash, alloc)
    {}

    small_unordered_multimap(std::initializer_list<value_type> ilist, size_type bucket_count, const Hash& hash, const KeyEqual& equal)
        : small_unordered_multimap(ilist.begin(), ilist.end(), bucket_count, hash, equal)
    {}

    small_unordered_multimap(std::initializer_list<value_type> ilist, size_type bucket_count, const Hash& hash, const KeyEqual& equal, const Allocator& alloc)
        : small_unordered_multimap(ilist.begin(), ilist.end(), bucket_count, hash, equal, alloc)
    {}

    small_unordered_multimap(const small_unordered_multimap& other)
        : hash_table_(other.hash_table_, sfl::dtl::hash_table_equal_t())
    {}

    small_unordered_multimap(const small_unordered_multimap& other, const Allocator& alloc)
        : hash_table_(other.hash_table_, sfl::dtl::hash_table_equal_t(), alloc)
    {}

    small_unordered_multimap(small_unordered_multimap&& other)
        : hash_table_(std::move(other.hash_table_), sfl::dtl::hash_table_equal_t())
    {}

    small_unordered_multimap(small_unordered_multimap&& other, const Allocator& alloc)
    ...
    small_unordered_multimap& operator=(const small_unordered_multimap& other)
    {
        hash_table_.assign_copy(other.hash_table_, sfl::dtl::hash_table_equal_t());
        return *this;
    }

    small_unordered_multimap& operator=(small_unordered_multimap&& other)
    {
        hash_table_.assign_move(other.hash_table_, sfl::dtl::hash_table_equal_t());
        return *this;
    }

    small_unordered_multimap& operator=(std::initializer_list<value_type> ilist)
    {
    ...
    void swap(small_unordered_multimap& other)
    {
...
private:
    ...
    friend bool operator==(const small_unordered_multimap<K2, T2, N2, M2, H2, E2, A2>& x, const small_unordered_multimap<K2, T2, N2, M2, H2, E2, A2>& y);
...
#endif // SFL_SMALL_UNORDERED_MULTIMAP_HPP_INCLUDED
