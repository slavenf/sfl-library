...
#ifndef SFL_FLAT_MULTISET_HPP_INCLUDED
#define SFL_FLAT_MULTISET_HPP_INCLUDED
...
private:
    ...
    friend bool operator==(const flat_multiset<K2, C2, A2>& x, const flat_multiset<K2, C2, A2>& y);
...
#endif // SFL_FLAT_MULTISET_HPP_INCLUDED
