...
#ifndef SFL_STATIC_UNORDERED_MULTISET_HPP_INCLUDED
#define SFL_STATIC_UNORDERED_MULTISET_HPP_INCLUDED
...
public:
    ...
    static_unordered_multiset(const Hash& hash)
        : hash_table_(StaticBucketCount, hash)
    {}

    static_unordered_multiset(const Hash& hash, const KeyEqual& equal)
        : hash_table_(StaticBucketCount, hash, equal)
    {}

    template <typename InputIt,
              sfl::dtl::enable_if_t<sfl::dtl::is_input_iterator<InputIt>::value>* = nullptr>
    static_unordered_multiset(InputIt first, InputIt last)
        : hash_table_(StaticBucketCount)
    {
        insert(first, last);
    }
    ...
    template <typename InputIt,
              sfl::dtl::enable_if_t<sfl::dtl::is_input_iterator<InputIt>::value>* = nullptr>
    static_unordered_multiset(InputIt first, InputIt last, const Hash& hash)
        : hash_table_(StaticBucketCount, hash)
    {
        insert(first, last);
    }
    ...
    template <typename InputIt,
              sfl::dtl::enable_if_t<sfl::dtl::is_input_iterator<InputIt>::value>* = nullptr>
    static_unordered_multiset(InputIt first, InputIt last, const Hash& hash, const KeyEqual& equal)
        : hash_table_(StaticBucketCount, hash, equal)
    {
        insert(first, last);
    }

    static_unordered_multiset(std::initializer_list<value_type> ilist)
        : static_unordered_multiset(ilist.begin(), ilist.end())
    {}

    static_unordered_multiset(std::initializer_list<value_type> ilist, const Hash& hash)
        : static_unordered_multiset(ilist.begin(), ilist.end(), hash)
    {}

    static_unordered_multiset(std::initializer_list<value_type> ilist, const Hash& hash, const KeyEqual& equal)
        : static_unordered_multiset(ilist.begin(), ilist.end(), hash, equal)
    {}

    static_unordered_multiset(const static_unordered_multiset& other)
        : hash_table_(other.hash_table_, sfl::dtl::hash_table_equal_t())
    {}

    static_unordered_multiset(static_unordered_multiset&& other)
    ...
    static_unordered_multiset(sfl::from_range_t, Range&& range)
        : hash_table_(StaticBucketCount)
    {
    ...
    template <sfl::dtl::container_compatible_range<value_type> Range>
    static_unordered_multiset(sfl::from_range_t, Range&& range, const Hash& hash)
        : hash_table_(StaticBucketCount, hash)
    {
        insert_range(std::forward<Range>(range));
    }
    ...
    template <sfl::dtl::container_compatible_range<value_type> Range>
    static_unordered_multiset(sfl::from_range_t, Range&& range, const Hash& hash, const KeyEqual& equal)
        : hash_table_(StaticBucketCount, hash, equal)
    {
        insert_range(std::forward<Range>(range));
    }
    ...
    static_unordered_multiset& operator=(const static_unordered_multiset& other)
    {
        hash_table_.assign_copy(other.hash_table_, sfl::dtl::hash_table_equal_t());
        return *this;
    }

    static_unordered_multiset& operator=(static_unordered_multiset&& other)
    {
        hash_table_.assign_move(other.hash_table_, sfl::dtl::hash_table_equal_t());
        return *this;
    }

    static_unordered_multiset& operator=(std::initializer_list<value_type> ilist)
    {
    ...
    void swap(static_unordered_multiset& other)
    {
...
private:
    ...
    friend bool operator==(const static_unordered_multiset<K2, N2, M2, H2, E2>& x, const static_unordered_multiset<K2, N2, M2, H2, E2>& y);
...
bool operator==
(
    const static_unordered_multiset<K, N, M, H, E>& x,
    const static_unordered_multiset<K, N, M, H, E>& y
)
{
...
void swap
(
    static_unordered_multiset<K, N, M, H, E>& x,
    static_unordered_multiset<K, N, M, H, E>& y
)
{
    x.swap(y);
}
...
typename static_unordered_multiset<K, N, M, H, E>::size_type
    erase_if(static_unordered_multiset<K, N, M, H, E>& c, Predicate pred)
{
...
#endif // SFL_STATIC_UNORDERED_MULTISET_HPP_INCLUDED
