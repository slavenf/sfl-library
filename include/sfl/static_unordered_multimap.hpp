...
#ifndef SFL_STATIC_UNORDERED_MULTIMAP_HPP_INCLUDED
#define SFL_STATIC_UNORDERED_MULTIMAP_HPP_INCLUDED
...
private:
    ...
    friend bool operator==(const static_unordered_multimap<K2, T2, N2, M2, H2, E2>& x, const static_unordered_multimap<K2, T2, N2, M2, H2, E2>& y);
...
#endif // SFL_STATIC_UNORDERED_MULTIMAP_HPP_INCLUDED
