...
#ifndef SFL_UNORDERED_SET_HPP_INCLUDED
#define SFL_UNORDERED_SET_HPP_INCLUDED
...
public:
    ...
    unordered_set(size_type bucket_count, const Hash& hash, const KeyEqual& equal, const Allocator& alloc)
    ...
    template <typename InputIt,
              sfl::dtl::enable_if_t<sfl::dtl::is_input_iterator<InputIt>::value>* = nullptr>
    unordered_set(InputIt first, InputIt last, size_type bucket_count, const Hash& hash, const KeyEqual& equal)
        : hash_table_(calculate_initial_bucket_count(bucket_count), hash, equal)
    {
        insert(first, last);
    }
    ...
    template <typename InputIt,
              sfl::dtl::enable_if_t<sfl::dtl::is_input_iterator<InputIt>::value>* = nullptr>
    unordered_set(InputIt first, InputIt last, size_type bucket_count, const Hash& hash, const KeyEqual& equal, const Allocator& alloc)
        : hash_table_(calculate_initial_bucket_count(bucket_count), hash, equal, alloc)
    {
        insert(first, last);
    }
    ...
    unordered_set(std::initializer_list<value_type> ilist, size_type bucket_count)
        : unordered_set(ilist.begin(), ilist.end(), bucket_count)
    {}

    unordered_set(std::initializer_list<value_type> ilist, size_type bucket_count, const Allocator& alloc)
        : unordered_set(ilist.begin(), ilist.end(), bucket_count, alloc)
    {}

    unordered_set(std::initializer_list<value_type> ilist, size_type bucket_count, const Hash& hash)
        : unordered_set(ilist.begin(), ilist.end(), bucket_count, hash)
    {}

    unordered_set(std::initializer_list<value_type> ilist, size_type bucket_count, const Hash& hash, const Allocator& alloc)
        : unordered_set(ilist.begin(), ilist.end(), bucket_count, hash, alloc)
    {}

    unordered_set(std::initializer_list<value_type> ilist, size_type bucket_count, const Hash& hash, const KeyEqual& equal)
        : unordered_set(ilist.begin(), ilist.end(), bucket_count, hash, equal)
    {}

    unordered_set(std::initializer_list<value_type> ilist, size_type bucket_count, const Hash& hash, const KeyEqual& equal, const Allocator& alloc)
        : unordered_set(ilist.begin(), ilist.end(), bucket_count, hash, equal, alloc)
    {}
    ...
    unordered_set(sfl::from_range_t, Range&& range)
        : hash_table_(calculate_initial_bucket_count(0))
    {
    ...
    template <sfl::dtl::container_compatible_range<value_type> Range>
    unordered_set(sfl::from_range_t, Range&& range, size_type bucket_count)
        : hash_table_(calculate_initial_bucket_count(bucket_count))
    {
        insert_range(std::forward<Range>(range));
    }
    ...
    template <sfl::dtl::container_compatible_range<value_type> Range>
    unordered_set(sfl::from_range_t, Range&& range, size_type bucket_count, const Allocator& alloc)
        : hash_table_(calculate_initial_bucket_count(bucket_count), alloc)
    {
        insert_range(std::forward<Range>(range));
    }
    ...
    template <sfl::dtl::container_compatible_range<value_type> Range>
    unordered_set(sfl::from_range_t, Range&& range, size_type bucket_count, const Hash& hash)
        : hash_table_(calculate_initial_bucket_count(bucket_count), hash)
    {
        insert_range(std::forward<Range>(range));
    }
    ...
    template <sfl::dtl::container_compatible_range<value_type> Range>
    unordered_set(sfl::from_range_t, Range&& range, size_type bucket_count, const Hash& hash, const Allocator& alloc)
        : hash_table_(calculate_initial_bucket_count(bucket_count), hash, alloc)
    {
        insert_range(std::forward<Range>(range));
    }
    ...
    template <sfl::dtl::container_compatible_range<value_type> Range>
    unordered_set(sfl::from_range_t, Range&& range, size_type bucket_count, const Hash& hash, const KeyEqual& equal)
        : hash_table_(calculate_initial_bucket_count(bucket_count), hash, equal)
    {
        insert_range(std::forward<Range>(range));
    }
    ...
    template <sfl::dtl::container_compatible_range<value_type> Range>
    unordered_set(sfl::from_range_t, Range&& range, size_type bucket_count, const Hash& hash, const KeyEqual& equal, const Allocator& alloc)
        : hash_table_(calculate_initial_bucket_count(bucket_count), hash, equal, alloc)
    {
        insert_range(std::forward<Range>(range));
    }
...
private:
    ...
    friend bool operator==(const unordered_set<K2, H2, E2, A2>& x, const unordered_set<K2, H2, E2, A2>& y);
...
bool operator==
(
    const unordered_set<K, H, E, A>& x,
    const unordered_set<K, H, E, A>& y
)
{
...
void swap
(
    unordered_set<K, H, E, A>& x,
    unordered_set<K, H, E, A>& y
)
{
    x.swap(y);
}
...
typename unordered_set<K, H, E, A>::size_type
    erase_if(unordered_set<K, H, E, A>& c, Predicate pred)
{
...
#endif // SFL_UNORDERED_SET_HPP_INCLUDED
