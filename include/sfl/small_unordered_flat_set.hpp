...
#ifndef SFL_SMALL_UNORDERED_FLAT_SET_HPP
#define SFL_SMALL_UNORDERED_FLAT_SET_HPP
...
#define SFL_DTL_BEGIN  namespace dtl { namespace small_unordered_flat_set_dtl {
#define SFL_DTL_END    } }
#define SFL_DTL        ::sfl::dtl::small_unordered_flat_set_dtl
...
class small_unordered_flat_set_data
{
private:
...
class small_unordered_flat_set_data<T, Pointer, 0>
{
public:
...
class small_unordered_flat_set : private Allocator, private KeyEqual
{
public:
...
private:
    ...
    SFL_DTL::small_unordered_flat_set_data<value_type, pointer, N> data_;
...
public:
    ...
    small_unordered_flat_set(small_unordered_flat_set&& other)
        ...
        , KeyEqual(std::move(other.ref_to_key_eq()))
    {
    ...
    void swap(small_unordered_flat_set& other)
    {
        ...
        swap(this->ref_to_key_eq(), other.ref_to_key_eq());
...
private:
    ...
    KeyEqual& ref_to_key_eq() noexcept
    {
        return *this;
    }

    const KeyEqual& ref_to_key_eq() const noexcept
    {
        return *this;
    }
    ...
    void assign_copy(const small_unordered_flat_set& other)
    {
        if (this != &other)
        {
            ...
            ref_to_key_eq() = other.ref_to_key_eq();
    ...
    iterator insert_aux(Args&&... args)
    {
        ...
        else
        {
            const size_type new_cap =
                recommend_size(1, "sfl::small_unordered_flat_set::insert_aux");
...
#endif // SFL_SMALL_UNORDERED_FLAT_SET_HPP
