...
public:
    ...
    {
        return tree_.erase_key_equal(key);
    }
    ...
    size_type erase(K&& x)
    {
        return tree_.erase_key_equal(x);
    }
...
private:
    ...
    friend bool operator==(const small_multimap<K2, T2, N2, C2, A2>& x, const small_multimap<K2, T2, N2, C2, A2>& y);
