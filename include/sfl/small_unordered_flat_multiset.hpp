...
#define SFL_DTL_END    } }
#define SFL_DTL        dtl::small_unordered_flat_multiset_dtl
...
class small_unordered_flat_multiset_data
{
private:
...
public:
    ...
    small_unordered_flat_multiset_data() noexcept
        : first_
        (
...
class small_unordered_flat_multiset_data<T, Pointer, 0>
{
public:
...
class small_unordered_flat_multiset : private Allocator, private KeyEqual
{
public:
...
private:
    ...
    SFL_DTL::small_unordered_flat_multiset_data<value_type, pointer, N> data_;
