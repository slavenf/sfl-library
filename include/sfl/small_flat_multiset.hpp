...
#define SFL_DTL_BEGIN  namespace dtl { namespace small_flat_multiset_dtl {
#define SFL_DTL_END    } }
#define SFL_DTL        ::sfl::dtl::small_flat_multiset_dtl
...
class small_flat_multiset_data
{
private:
...
public:
    ...
    small_flat_multiset_data() noexcept
        : first_
        (
...
class small_flat_multiset_data<T, Pointer, 0>
{
public:
...
class small_flat_multiset : private Allocator, private Compare
{
public:
...
private:
    ...
    SFL_DTL::small_flat_multiset_data<value_type, pointer, N> data_;
    ...
    iterator insert_aux(const_iterator pos, Args&&... args)
    {
        ...
        else
        {
            const size_type new_cap =
                recommend_size(1, "sfl::small_flat_multiset::insert_aux");
