...
#ifndef SFL_UNORDERED_MULTIMAP_HPP_INCLUDED
#define SFL_UNORDERED_MULTIMAP_HPP_INCLUDED
...
public:
    ...
    unordered_multimap(size_type bucket_count, const Hash& hash, const KeyEqual& equal)
        : hash_table_(calculate_initial_bucket_count(bucket_count), hash, equal)
    {}

    unordered_multimap(size_type bucket_count, const Hash& hash, const KeyEqual& equal, const Allocator& alloc)
    ...
    template <typename InputIt,
              sfl::dtl::enable_if_t<sfl::dtl::is_input_iterator<InputIt>::value>* = nullptr>
    unordered_multimap(InputIt first, InputIt last, size_type bucket_count)
        : hash_table_(calculate_initial_bucket_count(bucket_count))
    {
        insert(first, last);
    }
    ...
    template <typename InputIt,
              sfl::dtl::enable_if_t<sfl::dtl::is_input_iterator<InputIt>::value>* = nullptr>
    unordered_multimap(InputIt first, InputIt last, size_type bucket_count, const Hash& hash)
        : hash_table_(calculate_initial_bucket_count(bucket_count), hash)
    {
        insert(first, last);
    }
    ...
    template <typename InputIt,
              sfl::dtl::enable_if_t<sfl::dtl::is_input_iterator<InputIt>::value>* = nullptr>
    unordered_multimap(InputIt first, InputIt last, size_type bucket_count, const Hash& hash, const KeyEqual& equal)
        : hash_table_(calculate_initial_bucket_count(bucket_count), hash, equal)
    {
        insert(first, last);
    }
    ...
    template <typename InputIt,
              sfl::dtl::enable_if_t<sfl::dtl::is_input_iterator<InputIt>::value>* = nullptr>
    unordered_multimap(InputIt first, InputIt last, size_type bucket_count, const Hash& hash, const KeyEqual& equal, const Allocator& alloc)
        : hash_table_(calculate_initial_bucket_count(bucket_count), hash, equal, alloc)
    {
        insert(first, last);
    }
    ...
    unordered_multimap(std::initializer_list<value_type> ilist, size_type bucket_count)
        : unordered_multimap(ilist.begin(), ilist.end(), bucket_count)
    {}

    unordered_multimap(std::initializer_list<value_type> ilist, size_type bucket_count, const Allocator& alloc)
        : unordered_multimap(ilist.begin(), ilist.end(), bucket_count, alloc)
    {}

    unordered_multimap(std::initializer_list<value_type> ilist, size_type bucket_count, const Hash& hash)
        : unordered_multimap(ilist.begin(), ilist.end(), bucket_count, hash)
    {}

    unordered_multimap(std::initializer_list<value_type> ilist, size_type bucket_count, const Hash& hash, const Allocator& alloc)
        : unordered_multimap(ilist.begin(), ilist.end(), bucket_count, hash, alloc)
    {}

    unordered_multimap(std::initializer_list<value_type> ilist, size_type bucket_count, const Hash& hash, const KeyEqual& equal)
        : unordered_multimap(ilist.begin(), ilist.end(), bucket_count, hash, equal)
    {}

    unordered_multimap(std::initializer_list<value_type> ilist, size_type bucket_count, const Hash& hash, const KeyEqual& equal, const Allocator& alloc)
        : unordered_multimap(ilist.begin(), ilist.end(), bucket_count, hash, equal, alloc)
    {}
    ...
    unordered_multimap(sfl::from_range_t, Range&& range)
        : hash_table_(calculate_initial_bucket_count(0))
    {
    ...
    template <sfl::dtl::container_compatible_range<value_type> Range>
    unordered_multimap(sfl::from_range_t, Range&& range, size_type bucket_count)
        : hash_table_(calculate_initial_bucket_count(bucket_count))
    {
        insert_range(std::forward<Range>(range));
    }
    ...
    template <sfl::dtl::container_compatible_range<value_type> Range>
    unordered_multimap(sfl::from_range_t, Range&& range, size_type bucket_count, const Allocator& alloc)
        : hash_table_(calculate_initial_bucket_count(bucket_count), alloc)
    {
        insert_range(std::forward<Range>(range));
    }
    ...
    template <sfl::dtl::container_compatible_range<value_type> Range>
    unordered_multimap(sfl::from_range_t, Range&& range, size_type bucket_count, const Hash& hash)
        : hash_table_(calculate_initial_bucket_count(bucket_count), hash)
    {
        insert_range(std::forward<Range>(range));
    }
    ...
    template <sfl::dtl::container_compatible_range<value_type> Range>
    unordered_multimap(sfl::from_range_t, Range&& range, size_type bucket_count, const Hash& hash, const Allocator& alloc)
        : hash_table_(calculate_initial_bucket_count(bucket_count), hash, alloc)
    {
        insert_range(std::forward<Range>(range));
    }
    ...
    template <sfl::dtl::container_compatible_range<value_type> Range>
    unordered_multimap(sfl::from_range_t, Range&& range, size_type bucket_count, const Hash& hash, const KeyEqual& equal)
        : hash_table_(calculate_initial_bucket_count(bucket_count), hash, equal)
    {
        insert_range(std::forward<Range>(range));
    }
    ...
    template <sfl::dtl::container_compatible_range<value_type> Range>
    unordered_multimap(sfl::from_range_t, Range&& range, size_type bucket_count, const Hash& hash, const KeyEqual& equal, const Allocator& alloc)
        : hash_table_(calculate_initial_bucket_count(bucket_count), hash, equal, alloc)
    {
        insert_range(std::forward<Range>(range));
    }
    ...
    {
        return hash_table_.insert_equal(std::forward<P>(value));
    }
    ...
    {
        return hash_table_.insert_hint_equal(hint, std::forward<P>(value));
    }
...
private:
    ...
    friend bool operator==(const unordered_multimap<K2, T2, H2, E2, A2>& x, const unordered_multimap<K2, T2, H2, E2, A2>& y);
...
bool operator==
(
    const unordered_multimap<K, T, H, E, A>& x,
    const unordered_multimap<K, T, H, E, A>& y
)
{
...
void swap
(
    unordered_multimap<K, T, H, E, A>& x,
    unordered_multimap<K, T, H, E, A>& y
)
{
    x.swap(y);
}
...
typename unordered_multimap<K, T, H, E, A>::size_type
    erase_if(unordered_multimap<K, T, H, E, A>& c, Predicate pred)
{
...
#endif // SFL_UNORDERED_MULTIMAP_HPP_INCLUDED
