...
#ifndef SFL_SMALL_UNORDERED_MAP_HPP_INCLUDED
#define SFL_SMALL_UNORDERED_MAP_HPP_INCLUDED
...
public:
    ...
    using local_iterator       = typename hash_table::local_iterator;
...
public:
    ...
    explicit
    small_unordered_map(const Allocator& alloc)
        : hash_table_(calculate_initial_bucket_count(0), alloc)
    {}

    explicit
    small_unordered_map(size_type bucket_count)
    ...
    small_unordered_map(size_type bucket_count, const Hash& hash, const KeyEqual& equal, const Allocator& alloc)
        : hash_table_(calculate_initial_bucket_count(bucket_count), hash, equal, alloc)
    {}

    template <typename InputIt,
              sfl::dtl::enable_if_t<sfl::dtl::is_input_iterator<InputIt>::value>* = nullptr>
    small_unordered_map(InputIt first, InputIt last)
        : hash_table_(calculate_initial_bucket_count(0))
    {
        insert(first, last);
    }
    ...
    template <typename InputIt,
              sfl::dtl::enable_if_t<sfl::dtl::is_input_iterator<InputIt>::value>* = nullptr>
    small_unordered_map(InputIt first, InputIt last, size_type bucket_count)
        : hash_table_(calculate_initial_bucket_count(bucket_count))
    {
        insert(first, last);
    }
    ...
    template <typename InputIt,
              sfl::dtl::enable_if_t<sfl::dtl::is_input_iterator<InputIt>::value>* = nullptr>
    small_unordered_map(InputIt first, InputIt last, size_type bucket_count, const Allocator& alloc)
        : hash_table_(calculate_initial_bucket_count(bucket_count), alloc)
    {
        insert(first, last);
    }
    ...
    template <typename InputIt,
              sfl::dtl::enable_if_t<sfl::dtl::is_input_iterator<InputIt>::value>* = nullptr>
    small_unordered_map(InputIt first, InputIt last, size_type bucket_count, const Hash& hash)
        : hash_table_(calculate_initial_bucket_count(bucket_count), hash)
    {
        insert(first, last);
    }
    ...
    template <typename InputIt,
              sfl::dtl::enable_if_t<sfl::dtl::is_input_iterator<InputIt>::value>* = nullptr>
    small_unordered_map(InputIt first, InputIt last, size_type bucket_count, const Hash& hash, const Allocator& alloc)
        : hash_table_(calculate_initial_bucket_count(bucket_count), hash, alloc)
    {
        insert(first, last);
    }
    ...
    template <typename InputIt,
              sfl::dtl::enable_if_t<sfl::dtl::is_input_iterator<InputIt>::value>* = nullptr>
    small_unordered_map(InputIt first, InputIt last, size_type bucket_count, const Hash& hash, const KeyEqual& equal)
        : hash_table_(calculate_initial_bucket_count(bucket_count), hash, equal)
    {
        insert(first, last);
    }
    ...
    template <typename InputIt,
              sfl::dtl::enable_if_t<sfl::dtl::is_input_iterator<InputIt>::value>* = nullptr>
    small_unordered_map(InputIt first, InputIt last, size_type bucket_count, const Hash& hash, const KeyEqual& equal, const Allocator& alloc)
        : hash_table_(calculate_initial_bucket_count(bucket_count), hash, equal, alloc)
    {
        insert(first, last);
    }
    ...
    small_unordered_map(std::initializer_list<value_type> ilist)
        : small_unordered_map(ilist.begin(), ilist.end())
    {}

    small_unordered_map(std::initializer_list<value_type> ilist, size_type bucket_count)
        : small_unordered_map(ilist.begin(), ilist.end(), bucket_count)
    {}

    small_unordered_map(std::initializer_list<value_type> ilist, size_type bucket_count, const Allocator& alloc)
        : small_unordered_map(ilist.begin(), ilist.end(), bucket_count, alloc)
    {}

    small_unordered_map(std::initializer_list<value_type> ilist, size_type bucket_count, const Hash& hash)
        : small_unordered_map(ilist.begin(), ilist.end(), bucket_count, hash)
    {}

    small_unordered_map(std::initializer_list<value_type> ilist, size_type bucket_count, const Hash& hash, const Allocator& alloc)
        : small_unordered_map(ilist.begin(), ilist.end(), bucket_count, hash, alloc)
    {}

    small_unordered_map(std::initializer_list<value_type> ilist, size_type bucket_count, const Hash& hash, const KeyEqual& equal)
        : small_unordered_map(ilist.begin(), ilist.end(), bucket_count, hash, equal)
    {}

    small_unordered_map(std::initializer_list<value_type> ilist, size_type bucket_count, const Hash& hash, const KeyEqual& equal, const Allocator& alloc)
        : small_unordered_map(ilist.begin(), ilist.end(), bucket_count, hash, equal, alloc)
    {}
    ...
    small_unordered_map(const small_unordered_map& other, const Allocator& alloc)
    ...
    small_unordered_map(small_unordered_map&& other, const Allocator& alloc)
    ...
    small_unordered_map(sfl::from_range_t, Range&& range)
        : hash_table_(calculate_initial_bucket_count(0))
    {
    ...
    template <sfl::dtl::container_compatible_range<value_type> Range>
    small_unordered_map(sfl::from_range_t, Range&& range, size_type bucket_count)
        : hash_table_(calculate_initial_bucket_count(bucket_count))
    {
        insert_range(std::forward<Range>(range));
    }
    ...
    template <sfl::dtl::container_compatible_range<value_type> Range>
    small_unordered_map(sfl::from_range_t, Range&& range, size_type bucket_count, const Allocator& alloc)
        : hash_table_(calculate_initial_bucket_count(bucket_count), alloc)
    {
        insert_range(std::forward<Range>(range));
    }
    ...
    template <sfl::dtl::container_compatible_range<value_type> Range>
    small_unordered_map(sfl::from_range_t, Range&& range, size_type bucket_count, const Hash& hash)
        : hash_table_(calculate_initial_bucket_count(bucket_count), hash)
    {
        insert_range(std::forward<Range>(range));
    }
    ...
    template <sfl::dtl::container_compatible_range<value_type> Range>
    small_unordered_map(sfl::from_range_t, Range&& range, size_type bucket_count, const Hash& hash, const Allocator& alloc)
        : hash_table_(calculate_initial_bucket_count(bucket_count), hash, alloc)
    {
        insert_range(std::forward<Range>(range));
    }
    ...
    template <sfl::dtl::container_compatible_range<value_type> Range>
    small_unordered_map(sfl::from_range_t, Range&& range, size_type bucket_count, const Hash& hash, const KeyEqual& equal)
        : hash_table_(calculate_initial_bucket_count(bucket_count), hash, equal)
    {
        insert_range(std::forward<Range>(range));
    }
    ...
    template <sfl::dtl::container_compatible_range<value_type> Range>
    small_unordered_map(sfl::from_range_t, Range&& range, size_type bucket_count, const Hash& hash, const KeyEqual& equal, const Allocator& alloc)
        : hash_table_(calculate_initial_bucket_count(bucket_count), hash, equal, alloc)
    {
        insert_range(std::forward<Range>(range));
    }
    ...
    small_unordered_map& operator=(small_unordered_map&& other)
    {
        hash_table_.assign_move(other.hash_table_, sfl::dtl::hash_table_unique_t());
        return *this;
    }

    small_unordered_map& operator=(std::initializer_list<value_type> ilist)
    {
    ...
    {
        return hash_table_.insert_unique(std::forward<P>(value));
    }
    ...
    {
        return hash_table_.insert_hint_unique(hint, std::forward<P>(value));
    }
    ...
    {
        return hash_table_.insert_or_assign(key, std::forward<M>(obj));
    }
    ...
    {
        return hash_table_.insert_or_assign(std::move(key), std::forward<M>(obj));
    }
    ...
    {
        return hash_table_.insert_or_assign(std::forward<K>(key), std::forward<M>(obj));
    }
    ...
    {
        return hash_table_.insert_or_assign_hint(hint, key, std::forward<M>(obj));
    }
    ...
    {
        return hash_table_.insert_or_assign_hint(hint, std::move(key), std::forward<M>(obj));
    }
    ...
    {
        return hash_table_.insert_or_assign_hint(hint, std::forward<K>(key), std::forward<M>(obj));
    }

    template <typename... Args>
    std::pair<iterator, bool> try_emplace(const Key& key, Args&&... args)
    {
        return hash_table_.try_emplace(key, std::forward<Args>(args)...);
    }

    template <typename... Args>
    std::pair<iterator, bool> try_emplace(Key&& key, Args&&... args)
    {
        return hash_table_.try_emplace(std::move(key), std::forward<Args>(args)...);
    }
    ...
    template <typename K, typename... Args,
              sfl::dtl::enable_if_t<
                ...
                #endif
                sfl::dtl::has_is_transparent<Hash, K>::value &&
                sfl::dtl::has_is_transparent<KeyEqual, K>::value &&
    ...
    {
        return hash_table_.try_emplace(std::forward<K>(key), std::forward<Args>(args)...);
    }

    template <typename... Args>
    iterator try_emplace(const_iterator hint, const Key& key, Args&&... args)
    {
        return hash_table_.try_emplace_hint(hint, key, std::forward<Args>(args)...);
    }

    template <typename... Args>
    iterator try_emplace(const_iterator hint, Key&& key, Args&&... args)
    {
        return hash_table_.try_emplace_hint(hint, std::move(key), std::forward<Args>(args)...);
    }
    ...
    {
        return hash_table_.try_emplace_hint(hint, std::forward<K>(key), std::forward<Args>(args)...);
    }
    ...
    void swap(small_unordered_map& other)
    {
    ...
    T& at(const Key& key)
    {
        ...
        if (it == end())
        {
            sfl::dtl::throw_out_of_range("sfl::small_unordered_map::at");
        }
...
private:
    ...
    template <typename K2, typename T2, std::size_t N2, std::size_t M2, typename H2, typename E2, typename A2>
    friend bool operator==(const small_unordered_map<K2, T2, N2, M2, H2, E2, A2>& x, const small_unordered_map<K2, T2, N2, M2, H2, E2, A2>& y);
...
template <typename K, typename T, std::size_t N, std::size_t M, typename H, typename E, typename A>
SFL_NODISCARD
bool operator==
(
    const small_unordered_map<K, T, N, M, H, E, A>& x,
    const small_unordered_map<K, T, N, M, H, E, A>& y
)
{
...
void swap
(
    small_unordered_map<K, T, N, M, H, E, A>& x,
    small_unordered_map<K, T, N, M, H, E, A>& y
)
{
    x.swap(y);
}

template <typename K, typename T, std::size_t N, std::size_t M, typename H, typename E, typename A, typename Predicate>
typename small_unordered_map<K, T, N, M, H, E, A>::size_type
    erase_if(small_unordered_map<K, T, N, M, H, E, A>& c, Predicate pred)
{
...
#endif // SFL_SMALL_UNORDERED_MAP_HPP_INCLUDED
