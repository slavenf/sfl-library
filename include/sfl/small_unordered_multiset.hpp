...
#ifndef SFL_SMALL_UNORDERED_MULTISET_HPP_INCLUDED
#define SFL_SMALL_UNORDERED_MULTISET_HPP_INCLUDED
...
public:
    ...
    explicit
    small_unordered_multiset(const Allocator& alloc)
        : hash_table_(calculate_initial_bucket_count(0), alloc)
    {}

    explicit
    small_unordered_multiset(size_type bucket_count)
        : hash_table_(calculate_initial_bucket_count(bucket_count))
    {}

    small_unordered_multiset(size_type bucket_count, const Allocator& alloc)
        : hash_table_(calculate_initial_bucket_count(bucket_count), alloc)
    {}

    small_unordered_multiset(size_type bucket_count, const Hash& hash)
        : hash_table_(calculate_initial_bucket_count(bucket_count), hash)
    {}

    small_unordered_multiset(size_type bucket_count, const Hash& hash, const Allocator& alloc)
        : hash_table_(calculate_initial_bucket_count(bucket_count), hash, alloc)
    {}

    small_unordered_multiset(size_type bucket_count, const Hash& hash, const KeyEqual& equal)
        : hash_table_(calculate_initial_bucket_count(bucket_count), hash, equal)
    {}

    small_unordered_multiset(size_type bucket_count, const Hash& hash, const KeyEqual& equal, const Allocator& alloc)
        : hash_table_(calculate_initial_bucket_count(bucket_count), hash, equal, alloc)
    {}

    template <typename InputIt,
              sfl::dtl::enable_if_t<sfl::dtl::is_input_iterator<InputIt>::value>* = nullptr>
    small_unordered_multiset(InputIt first, InputIt last)
        : hash_table_(calculate_initial_bucket_count(0))
    {
        insert(first, last);
    }
    ...
    template <typename InputIt,
              sfl::dtl::enable_if_t<sfl::dtl::is_input_iterator<InputIt>::value>* = nullptr>
    small_unordered_multiset(InputIt first, InputIt last, size_type bucket_count)
        : hash_table_(calculate_initial_bucket_count(bucket_count))
    {
        insert(first, last);
    }
    ...
    template <typename InputIt,
              sfl::dtl::enable_if_t<sfl::dtl::is_input_iterator<InputIt>::value>* = nullptr>
    small_unordered_multiset(InputIt first, InputIt last, size_type bucket_count, const Allocator& alloc)
        : hash_table_(calculate_initial_bucket_count(bucket_count), alloc)
    {
        insert(first, last);
    }
    ...
    template <typename InputIt,
              sfl::dtl::enable_if_t<sfl::dtl::is_input_iterator<InputIt>::value>* = nullptr>
    small_unordered_multiset(InputIt first, InputIt last, size_type bucket_count, const Hash& hash)
        : hash_table_(calculate_initial_bucket_count(bucket_count), hash)
    {
        insert(first, last);
    }
    ...
    template <typename InputIt,
              sfl::dtl::enable_if_t<sfl::dtl::is_input_iterator<InputIt>::value>* = nullptr>
    small_unordered_multiset(InputIt first, InputIt last, size_type bucket_count, const Hash& hash, const Allocator& alloc)
        : hash_table_(calculate_initial_bucket_count(bucket_count), hash, alloc)
    {
        insert(first, last);
    }
    ...
    template <typename InputIt,
              sfl::dtl::enable_if_t<sfl::dtl::is_input_iterator<InputIt>::value>* = nullptr>
    small_unordered_multiset(InputIt first, InputIt last, size_type bucket_count, const Hash& hash, const KeyEqual& equal)
        : hash_table_(calculate_initial_bucket_count(bucket_count), hash, equal)
    {
        insert(first, last);
    }
    ...
    template <typename InputIt,
              sfl::dtl::enable_if_t<sfl::dtl::is_input_iterator<InputIt>::value>* = nullptr>
    small_unordered_multiset(InputIt first, InputIt last, size_type bucket_count, const Hash& hash, const KeyEqual& equal, const Allocator& alloc)
        : hash_table_(calculate_initial_bucket_count(bucket_count), hash, equal, alloc)
    {
        insert(first, last);
    }

    small_unordered_multiset(std::initializer_list<value_type> ilist)
        : small_unordered_multiset(ilist.begin(), ilist.end())
    {}

    small_unordered_multiset(std::initializer_list<value_type> ilist, size_type bucket_count)
        : small_unordered_multiset(ilist.begin(), ilist.end(), bucket_count)
    {}

    small_unordered_multiset(std::initializer_list<value_type> ilist, size_type bucket_count, const Allocator& alloc)
        : small_unordered_multiset(ilist.begin(), ilist.end(), bucket_count, alloc)
    {}

    small_unordered_multiset(std::initializer_list<value_type> ilist, size_type bucket_count, const Hash& hash)
        : small_unordered_multiset(ilist.begin(), ilist.end(), bucket_count, hash)
    {}

    small_unordered_multiset(std::initializer_list<value_type> ilist, size_type bucket_count, const Hash& hash, const Allocator& alloc)
        : small_unordered_multiset(ilist.begin(), ilist.end(), bucket_count, hash, alloc)
    {}

    small_unordered_multiset(std::initializer_list<value_type> ilist, size_type bucket_count, const Hash& hash, const KeyEqual& equal)
        : small_unordered_multiset(ilist.begin(), ilist.end(), bucket_count, hash, equal)
    {}

    small_unordered_multiset(std::initializer_list<value_type> ilist, size_type bucket_count, const Hash& hash, const KeyEqual& equal, const Allocator& alloc)
        : small_unordered_multiset(ilist.begin(), ilist.end(), bucket_count, hash, equal, alloc)
    {}

    small_unordered_multiset(const small_unordered_multiset& other)
        : hash_table_(other.hash_table_, sfl::dtl::hash_table_equal_t())
    {}

    small_unordered_multiset(const small_unordered_multiset& other, const Allocator& alloc)
        : hash_table_(other.hash_table_, sfl::dtl::hash_table_equal_t(), alloc)
    {}

    small_unordered_multiset(small_unordered_multiset&& other)
        : hash_table_(std::move(other.hash_table_), sfl::dtl::hash_table_equal_t())
    {}

    small_unordered_multiset(small_unordered_multiset&& other, const Allocator& alloc)
    ...
    small_unordered_multiset(sfl::from_range_t, Range&& range)
        : hash_table_(calculate_initial_bucket_count(0))
    {
    ...
    template <sfl::dtl::container_compatible_range<value_type> Range>
    small_unordered_multiset(sfl::from_range_t, Range&& range, size_type bucket_count)
        : hash_table_(calculate_initial_bucket_count(bucket_count))
    {
        insert_range(std::forward<Range>(range));
    }
    ...
    template <sfl::dtl::container_compatible_range<value_type> Range>
    small_unordered_multiset(sfl::from_range_t, Range&& range, size_type bucket_count, const Allocator& alloc)
        : hash_table_(calculate_initial_bucket_count(bucket_count), alloc)
    {
        insert_range(std::forward<Range>(range));
    }
    ...
    template <sfl::dtl::container_compatible_range<value_type> Range>
    small_unordered_multiset(sfl::from_range_t, Range&& range, size_type bucket_count, const Hash& hash)
        : hash_table_(calculate_initial_bucket_count(bucket_count), hash)
    {
        insert_range(std::forward<Range>(range));
    }
    ...
    template <sfl::dtl::container_compatible_range<value_type> Range>
    small_unordered_multiset(sfl::from_range_t, Range&& range, size_type bucket_count, const Hash& hash, const Allocator& alloc)
        : hash_table_(calculate_initial_bucket_count(bucket_count), hash, alloc)
    {
        insert_range(std::forward<Range>(range));
    }
    ...
    template <sfl::dtl::container_compatible_range<value_type> Range>
    small_unordered_multiset(sfl::from_range_t, Range&& range, size_type bucket_count, const Hash& hash, const KeyEqual& equal)
        : hash_table_(calculate_initial_bucket_count(bucket_count), hash, equal)
    {
        insert_range(std::forward<Range>(range));
    }
    ...
    template <sfl::dtl::container_compatible_range<value_type> Range>
    small_unordered_multiset(sfl::from_range_t, Range&& range, size_type bucket_count, const Hash& hash, const KeyEqual& equal, const Allocator& alloc)
        : hash_table_(calculate_initial_bucket_count(bucket_count), hash, equal, alloc)
    {
        insert_range(std::forward<Range>(range));
    }
    ...
    small_unordered_multiset& operator=(const small_unordered_multiset& other)
    {
        hash_table_.assign_copy(other.hash_table_, sfl::dtl::hash_table_equal_t());
        return *this;
    }

    small_unordered_multiset& operator=(small_unordered_multiset&& other)
    {
        hash_table_.assign_move(other.hash_table_, sfl::dtl::hash_table_equal_t());
        return *this;
    }

    small_unordered_multiset& operator=(std::initializer_list<value_type> ilist)
    {
    ...
    void swap(small_unordered_multiset& other)
    {
...
private:
    ...
    friend bool operator==(const small_unordered_multiset<K2, N2, M2, H2, E2, A2>& x, const small_unordered_multiset<K2, N2, M2, H2, E2, A2>& y);
...
bool operator==
(
    const small_unordered_multiset<K, N, M, H, E, A>& x,
    const small_unordered_multiset<K, N, M, H, E, A>& y
)
{
...
void swap
(
    small_unordered_multiset<K, N, M, H, E, A>& x,
    small_unordered_multiset<K, N, M, H, E, A>& y
)
{
    x.swap(y);
}
...
typename small_unordered_multiset<K, N, M, H, E, A>::size_type
    erase_if(small_unordered_multiset<K, N, M, H, E, A>& c, Predicate pred)
{
...
#endif // SFL_SMALL_UNORDERED_MULTISET_HPP_INCLUDED
