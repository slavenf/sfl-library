...
#ifndef SFL_SMALL_UNORDERED_FLAT_MULTIMAP_HPP
#define SFL_SMALL_UNORDERED_FLAT_MULTIMAP_HPP
...
#define SFL_DTL_BEGIN  namespace dtl { namespace small_unordered_flat_multimap_dtl {
#define SFL_DTL_END    } }
#define SFL_DTL        ::sfl::dtl::small_unordered_flat_multimap_dtl
