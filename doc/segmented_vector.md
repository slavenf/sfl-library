...
`sfl::segmented_vector` can be used in C++20 constant expressions. However, `sfl::segmented_vector` objects generally cannot be `constexpr`, because any dynamically allocated storage must be released in the same evaluation of constant expression.
