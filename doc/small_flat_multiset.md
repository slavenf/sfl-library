...
`sfl::small_flat_multiset` is an associative container similar to [`std::multiset`](https://en.cppreference.com/w/cpp/container/multiset) with the underlying storage implemented as a sorted vector.
