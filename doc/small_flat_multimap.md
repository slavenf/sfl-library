...
`sfl::small_flat_multimap` is an associative container similar to [`std::multimap`](https://en.cppreference.com/w/cpp/container/multimap) with the underlying storage implemented as a sorted vector.
