...
`sfl::flat_set` can be used in C++20 constant expressions. However, `sfl::flat_set` objects generally cannot be `constexpr`, because any dynamically allocated storage must be released in the same evaluation of constant expression.
