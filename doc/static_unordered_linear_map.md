...
* On GCC, it is not possible to declare `constexpr` objects of `static_unordered_linear_map`. Clang and MSVC allow this, so this is a compiler-specific limitation (possibly a bug).
