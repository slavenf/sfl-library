...
`sfl::unordered_multiset` is an associative container equivalent to [`std::unordered_multiset`](https://en.cppreference.com/w/cpp/container/unordered_multiset).
...
1.  ```
    ...
    (
        ...
        const unordered_multiset<K, H, E, A>& y
    );
    ```
